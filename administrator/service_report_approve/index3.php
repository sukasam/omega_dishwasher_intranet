...
<div style="float:right;padding-top:5px;">
	<form name="form1" method="get" action="index3.php">
...
<div style="float:right;margin-right:20px;padding-top:5px;">  
    ...
    <select name="catalog_master" id="catalog_master" style="height:24px;" onChange="MM_jumpMenu('parent',this,0)">
		<option value="index3.php?app_id=0" <?php  if($_GET['app_id'] == 0){echo "selected";}?>>รอการอนุมัติ</option>
		 <option value="index3.php?app_id=1" <?php  if($_GET['app_id'] == 1){echo "selected";}?>>อนุมัติ</option>
         <option value="index3.php?app_id=2" <?php  if($_GET['app_id'] == 2){echo "selected";}?>>ไม่อนุมัติ</option>
         <!--<option value="index3.php?app_id=3" <?php  if($_GET['app_id'] == 3){echo "selected";}?>>จ่ายแล้ว</option>-->
  	</select>
    </div>
<DIV class=clear>
