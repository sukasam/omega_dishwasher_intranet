...
<?php 
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>'.$_POST['companyName'].'</strong> โดย <strong>นางอัญชลี  อภิรักษ์โยธิน/นายคณวัฒน์ อภิรักษ์โยธิน</strong> กรรมการผู้มีอำนาจ สำนักงานตั้งอยู่เลขที่ '.$_POST['companyAddress'].'  เบอร์โทร '.$_POST['companyTelephone'].' ซึ่งต่อไปในสัญญานี้จะเรียกว่า “ผู้ขาย” ฝ่ายหนึ่ง กับ<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="colorRed">บริษัทฯ ไม่มีนโยบายให้พนักงานรับชำระค่าสินค้าและค่าบริการจากลูกค้าผ่านบัญชีธนาคาร ส่วนตัวของพนักงาน
...
ยังคงเป็นทรัพย์สินของ'.$_POST['companyName'].' ถึงงวดสุดท้าย ตามข้อ 3. หากคู่สัญญาฝ่ายหนึ่งฝ่ายใดผิดสัญญาให้อีกฝ่ายหนึ่งมีสิทธิบอกเลิกสัญญาและมีสิทธิเรียกร้องค่าเสียหายจากฝ่ายที่ผิดสัญญาได้ตามความเป็นจริง <br><br>
