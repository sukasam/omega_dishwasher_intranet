	...
	?>
              <tr <?php  if ($counter++%2) { ?>class="oddrowbg" <?php  } else { ?> class="evenrowbg"<?php  } ?>>
                ...
                <td valign="middle"><div align="center">
                    ...
                    <img src="../images/check<?php  echo $image?>.gif" border="0"> </div></td>
                <td><div align="center"><a href="../contract/?action=Edit&mode=<?php  echo $_GET['mode']?>&<?php  echo "$PK_field=".$rec[$PK_field];?>&user_p_id=<?php  echo $rec[user_p_id];?>&module_id=<?php  echo $rec[module_id];?>&<?php  echo $param;?>">Edit</a></div></td>
