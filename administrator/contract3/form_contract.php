...
<?php 
	...
	foreach ($_POST['chkPro'] as $key => $value) {
		...
		$proList .= get_proname($conn,$finfos['cpro'.$value]).' OMEGA &nbsp;&nbsp;รุ่น	'.$finfos['pro_pod'.$value].'  จำนวน '.$finfos['camount'.$value].' เครื่อง เป็นเงิน '.number_format($priceP).' บาท ('.baht_text($priceP).')';
		
		$proList2 .= get_proname($conn,$finfos['cpro'.$value]).' OMEGA &nbsp;&nbsp;รุ่น	'.$finfos['pro_pod'.$value];
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>บริษัท โอเมก้า ดิชวอชเชอร์ (ประเทศไทย) จำกัด</strong> โดย <strong>นางอัญชลี  อภิรักษ์โยธิน/นายคณวัฒน์ อภิรักษ์โยธิน</strong> กรรมการผู้มีอำนาจ สำนักงานตั้งอยู่เลขที่ 31 ซอยโชคชัย 4 ซอย 50 แยก 4 ถนนโชคชัย 4 แขวงลาดพร้าว เขตลาดพร้าวกรุงเทพมหานคร รหัสไปรษณีย์ 10230  เบอร์โทร 02-530-6357, 062-335-5285 แฟกซ์ 02-539-6842 ซึ่งต่อไปในสัญญานี้จะเรียกว่า “ผู้ขาย” ฝ่ายหนึ่ง กับ<br><br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 1.</strong>  คู่สัญญาทั้งสองฝ่ายตกลงให้ถือเอาเอกสารที่แนบท้ายสัญญานี้เป็นส่วนหนึ่งแห่งสัญญานี้ด้วย คือ
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 4.</strong> '.$proList2.' ยังคงเป็นทรัพย์สินของบริษัท โอเมก้า ดิชวอชเชอร์ (ประเทศไทย) จำกัด ถึงงวดสุดท้าย ตามข้อ 3. หากคู่สัญญาฝ่ายหนึ่งฝ่ายใดผิดสัญญาให้อีกฝ่ายหนึ่งมีสิทธิบอกเลิกสัญญาและมีสิทธิเรียกร้องค่าเสียหายจากฝ่ายที่ผิดสัญญาได้ตามความเป็นจริง <br><br>
...
หน้าพยาน<br><br>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;margin-top:5px;">
      <tr>
        ...
        <td width="50%" class="signature" style="vertical-align: top;text-align: center;">
        	ลงชื่อ ………………………………… ผู้ขาย<br><br>
