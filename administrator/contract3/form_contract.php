...
<?php 
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>'.$finfos['name_consign'].'</strong> โดย กรรมการผู้มีอำนาจ สำนักงานตั้งอยู่เลขที่ '.$finfos['cd_address'].' โทรศัพท์ '.$finfos['cd_tel'].' โทรสาร '.$finfos['cd_fax'].' ซึ่งต่อไปในสัญญานี้จะเรียกว่า “ผู้ซื้อ” อีกฝ่ายหนึ่ง คู่สัญญาทั้งสองฝ่ายตกลงทำสัญญานี้ ดังมีเงื่อนไขรายละเอียดต่อไปนี้: -<br><br>';
