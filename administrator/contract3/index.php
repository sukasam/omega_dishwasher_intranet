...
<UL class=shortcut-buttons-set>
  <LI><A class=shortcut-button href="../contract3/update.php?mode=add<?php  if ($param <> "") echo "&".$param; ?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
    เพิ่ม</SPAN></A></LI>
...
<div style="float:right;padding-top:5px;">
	<form name="form1" method="get" action="../contract3/index.php">
    ...
    <?php
			...
			$param2 = get_param($a_param,$a_not_exists);
			  ?>
    <a href="../contract3/index.php?<?php  echo $param2;?>">แสดงทั้งหมด</a>
    <?php
			/*$a_not_exists = array();
...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="../contract3/confirm.php" onSubmit="return check_select(this)">
    <TABLE>
      <THEAD>
        <TR>
