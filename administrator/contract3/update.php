...
if ($_POST['mode'] != "") {
	...
	if(userGroup($conn,$_SESSION['login_id']) === "Dealer"){
        ...
        $_POST['companyAddress'] = '201 ซอยโชคชัย 4 ซอย 54 ถนนโชคชัย 4 แขวงลาดพร้าวเขตลาดพร้าว กรุงเทพมหานคร 10230';
  ...
  <form action="update.php" method="post" enctype="multipart/form-data" name="form1" id="form1"  onSubmit="return check(this)">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
          <tr>
            ...
            <td>
            	<strong>เลขที่สัญญา : <input type="text" name="con_id" value="<?php if ($con_id == "") {echo check_contract3_number($conn);} else {echo $con_id;}
