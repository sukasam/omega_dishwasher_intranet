...
for($i=0;$i<=count($_POST['cpro']);$i++){
	if($_POST['cpro'][$i] != ""){
		...
		$projectPro .= '<tr>
		  ...
		  <td style="border:1px solid #000000;padding:5;">'.get_product_id($conn,$_POST['cpro'][$i]).'</td>
		  <td style="border:1px solid #000000;text-align:left;padding:5;">'.get_product_name($conn,$_POST['cpro'][$i]).'</td>
		  <td style="border:1px solid #000000;text-align:center;padding:5;">'.getpod_name($conn,$_POST['cpod'][$i]).'</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:10px;text-align:center;margin-top:10px;">
    <tr>
      ...
      <td width="20%" style="border:1px solid #000000;font-size:10px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><strong>รายการ</strong></td>
    ...
    <tr>
      <td colspan="4" rowspan="2" style="text-align:left;border:0px solid #000000;padding:5;vertical-align:top;padding-top:15px;">
      </td>
