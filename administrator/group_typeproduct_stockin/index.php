<?php    
	...
	if($_GET["action"] == "delete"){
		...
		if ($code == "1") {
			...
			$sql2 = "select * from s_group_typeproduct_bill_pro where id_bill = '".$_GET[$PK_field]."'";
			...
			$sql = "delete from s_group_typeproduct_bill_pro  where id_bill = '".$_GET[$PK_field]."'";
			@mysqli_query($conn,$sql);	
...
<UL class=shortcut-buttons-set>
    <LI><A class=shortcut-button href="../group_typeproduct/index.php"><SPAN><IMG  alt=icon src="../images/menu/mn_serting06.png"><BR>
    สต๊อคสินค้า</SPAN></A></LI>
    <LI><A class=shortcut-button href="../group_typeproduct/update.php?mode=add"><SPAN><IMG  alt=icon src="../images/menu/mn_serting21.png"><BR>
    ...
    <TABLE>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD><center><A title="view" href="../../upload/stockin/<?php echo $rec["sub_id"];?>_product.pdf" target="_blank"><IMG alt="view" src="../images/icon2/backup.png" width="25"></A></center></TD>
           <TD><!-- Icons -->
