...
if($_GET['action'] === "chkProID"){
	...
	if($rowSpar['group_id']){
		echo json_encode(array('status' => 'yes','group_id'=> $rowSpar['group_id'],'group_spro_id'=> $rowSpar['group_spro_id'],'group_name'=> $rowSpar['group_name'],'group_namecall'=> $rowSpar['group_namecall'],'group_unit_price'=> $rowSpar['group_unit_price'],'group_price'=> $rowSpar['group_price']));
	}else{
