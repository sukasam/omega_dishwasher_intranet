...
<title>เลือกตามชื่อผู้ขาย ( <?php  echo get_sale_id($conn,$cs_sell);?> )</title>
<style type="text/css">
 .tbreport{
 	font-size:10px;
 }
...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
	  <tr>
        ...
        รายงานตามชื่อผู้ขาย ( <?php  echo get_sale_id($conn,$cs_sell). " : ". getsalename($conn,$cs_sell);?> )</th>
      ...
      <?php  
		$sql = "SELECT * FROM s_first_order WHERE cs_sell = '".$cs_sell."' ".$daterriod." ORDER BY fo_id ASC";
