                          ...
                          <table class="formFields" cellspacing="0" width="100%">
                            ...
                            <tr>
                              ...
                              <td><span class="name">
                                  ...
                                  <img src="../icons/favorites_close.png" width="15" height="15"> ยกเลิก</span></td>
                            </tr>
                            <tr>
                      ...
                      <tr>
                        <td>
                          <table class="formFields" cellspacing="0" width="100%">
                            ...
                            <tr>
                              <td nowrap class="name">รายการแสดง</td>
                              <td><input name="sh1" type="checkbox" id="sh14" value="1" checked>
                                ชื่อลูกค้า / บริษัท + เบอร์โทร
                                <input name="sh2" type="checkbox" id="sh15" value="1" checked>
                                ชื่อร้าน / สถานที่ติดตั้ง
                                <input name="sh3" type="checkbox" id="sh16" value="1" checked>
                                จังหวัด
                                <input name="sh4" type="checkbox" id="sh17" value="1" checked>
                                ประเภทลูกค้า <br>
                                <input name="sh5" type="checkbox" id="sh18" value="1" checked>
                                กลุ่มลูกค้า
                                <input name="sh6" type="checkbox" id="sh19" value="1" checked>
                                สินค้า
                                <input name="sh7" type="checkbox" id="sh53" value="1" checked>
                                รุ่นเครื่อง/SN/
                                <input name="sh8" type="checkbox" id="sh56" value="1" checked>
                                ราคาขาย/ค่าเช่า
                                <input name="sh9" type="checkbox" id="sh58" value="1" checked>
                                วันที่ติดตั้ง</td>
                            </tr>
                            <tr>
                              <td nowrap class="name">&nbsp;</td>
      ...
      ?>
        <DIV class=content-box>
          ...
          <DIV class=content-box-header align="right" style="padding-right:15px;">
            ...
            <H3 align="left">รายงานใบสั่งน้ำยา</H3>
            <DIV class=clear>
          ...
          <DIV class=content-box-content>
            <DIV id=tab1 class="tab-content default-tab">
              <!-- This is the target div. id must match the href of this div's tab -->
              <form action="report13.php" method="post" name="form1" id="form1" target="_blank" onSubmit="return check2(this)">
                <div class="formArea">
                  <fieldset>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td>
                          <table class="formFields" cellspacing="0" width="100%">
                            <tr>
                              <td width="10%" nowrap class="name">สถานะใบสั่งน้ำยา</td>
                              <td width="90%">
                                <select name="order_status">
                                  <option value="">สถานะทั้งหมด</option>
                                  <option value="0"><?php echo getStatusSolution(0); ?></option>
                                  <option value="1"><?php echo getStatusSolution(1); ?></option>
                                  <option value="2"><?php echo getStatusSolution(2); ?></option>
                                  <option value="3"><?php echo getStatusSolution(3); ?></option>
                                  <option value="4"><?php echo getStatusSolution(4); ?></option>
                                  <option value="5"><?php echo getStatusSolution(5); ?></option>
                                  <option value="6"><?php echo getStatusSolution(6); ?></option>
                                </select>
                              </td>
                            </tr>
                            <tr>
        ...
        ?>
          <DIV class=content-box>
            ...
            <DIV class=content-box-header align="right" style="padding-right:15px;">
              ...
              <H3 align="left">รายงานวันหมดอายุสัญญา</H3>
              <DIV class=clear>
            ...
            <DIV class=content-box-content>
              <DIV id=tab1 class="tab-content default-tab">
                <!-- This is the target div. id must match the href of this div's tab -->
                <form action="report14.php" method="post" name="form1" id="form1" target="_blank" onSubmit="return check2(this)">
                  <div class="formArea">
                    <fieldset>
                      <table width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          <td>
                            <table class="formFields" cellspacing="0" width="100%">
                              <tr>
                                <td width="10%" nowrap class="name">ประเภทสัญญา</td>
                                <td width="90%">
                                  <select name="contact_status">
                                    <option value="1">สัญญาเช่า</option>
                                    <option value="2">สัญญาบริการ</option>
                                  </select>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td width="10%" nowrap class="name">เริ่มวันที่</td>
                                <td width="90%"><input type="text" name="date_fm" readonly value="<?php echo date("d/m/Y", strtotime("-1 months")); ?>" class="inpfoder" />
                                  <script language="JavaScript">
                                    new tcal({
                                      'formname': 'form1',
                                      'controlname': 'date_fm'
