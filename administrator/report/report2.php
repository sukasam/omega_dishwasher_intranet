...
<title>เลือกตามจังหวัด ( <?php  echo province_name($conn,$cd_province);?> )</title>
<style type="text/css">
 .tbreport{
 	font-size:10px;
 }
...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
	  <tr>
        ...
        รายงานตามจังหวัด ( <?php  echo province_name($conn,$cd_province);?> )</th>
      ...
      <?php  
		$sql = "SELECT * FROM s_first_order WHERE cd_province = ".$cd_province." ".$daterriod." ".$codi."  ORDER BY date_forder ASC";
