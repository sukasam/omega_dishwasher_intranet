...
<title>เลือกตามกลุ่มลูกค้า ( <?php  echo get_groupcusname($cg_type);?> )</title>
<style type="text/css">
 .tbreport{
 	font-size:10px;
 }
...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
	  <tr>
        ...
        รายงานตามกลุ่มลูกค้า ( <?php  echo get_groupcusname($cg_type);?> )</th>
      ...
      <?php  
		...
		while($row_fr = @mysql_fetch_array($qu_fr)){
			...
			<tr>
              ...
              <?php  if($_REQUEST['sh3'] == 1){?><td><?php  echo custype_name($row_fr['ctype']);?></td><?php  }?>
              <?php  if($_REQUEST['sh4'] == 1 || $_REQUEST['sh5'] == 1 || $_REQUEST['sh6'] == 1){?><td style="padding:0;">
                ...
                <?php  
					if($row_fr['cpro1'] != ""){
						?>
						<tr>
                          <?php  if($_REQUEST['sh4'] == 1){?><td style="border:0;padding-bottom:0;" width="34%"><?php  echo get_proname($row_fr['cpro1']);?></td><?php  }?>
                ...
                <?php  
					if($row_fr['cpro2'] != ""){
						?>
						<tr>
                          <?php  if($_REQUEST['sh4'] == 1){?><td style="border:0;padding-bottom:0;padding-top:0;" width="34%"><?php  echo get_proname($row_fr['cpro2']);?></td><?php  }?>
                ...
                <?php  
					if($row_fr['cpro3'] != ""){
						?>
						<tr>
                          <?php  if($_REQUEST['sh4'] == 1){?><td style="border:0;padding-bottom:0;padding-top:0;" width="34%"><?php  echo get_proname($row_fr['cpro3']);?></td><?php  }?>
                ...
                <?php  
					if($row_fr['cpro4'] != ""){
						?>
						<tr>
                          <?php  if($_REQUEST['sh4'] == 1){?><td style="border:0;padding-bottom:0;padding-top:0;" width="34%"><?php  echo get_proname($row_fr['cpro4']);?></td><?php  }?>
                ...
                <?php  
					if($row_fr['cpro5'] != ""){
						?>
						<tr>
                          <?php  if($_REQUEST['sh4'] == 1){?><td style="border:0;padding-bottom:0;padding-top:0;" width="34%"><?php  echo get_proname($row_fr['cpro5']);?></td><?php  }?>
                ...
                <?php  
					if($row_fr['cpro6'] != ""){
						?>
						<tr>
                          <?php  if($_REQUEST['sh4'] == 1){?><td style="border:0;padding-bottom:0;padding-top:0;" width="34%"><?php  echo get_proname($row_fr['cpro6']);?></td><?php  }?>
                ...
                <?php  
					if($row_fr['cpro7'] != ""){
						?>
						<tr>
                          <?php  if($_REQUEST['sh4'] == 1){?><td style="border:0;padding-bottom:0;padding-top:0;" width="34%"><?php  echo get_proname($row_fr['cpro7']);?></td><?php  }?>
              ...
              <?php  if($_REQUEST['sh7'] == 1){?><td><?php  echo get_sale_id($row_fr['cs_sell']);?></td><?php  }?>
            </tr>
			<?php 
			$sum += 1;	
		}
