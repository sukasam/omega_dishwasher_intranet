...
<?php 
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>บริษัท โอเมก้า กรุ๊ป คอร์ปอเรชั่น จำกัด  จำกัด</strong>  โดย นายคณวัฒน์ อภิรักษ์โยธิน  กรรมการผู้มีอำนาจ ลงนาม สำนักงานตั้งอยู่เลขที่ '.$_POST['companyAddress'].' โทรศัพท์ '.$_POST['companyTelephone'].'  ซึ่งต่อไปนี้ในสัญญาเรียกว่า <strong>“ผู้ให้บริการ”</strong> ฝ่ายหนึ่ง กับ
...
วันที่เริ่มสัญญาบริการ <mark>'.format_date_th($_POST['con_startdate'],1).'</mark>	วันสิ้นสุดสัญญาบริการ  <mark>'.format_date_th($_POST['con_enddate'],1).'</mark>
	...
	บริษัทฯ จะไม่รับผิดชอบต่อความเสียหาย/สูญเสียทีเกิดขึ้น ไม่ว่าจะกรณี ใดๆทั้งสิ้น</span><br>
