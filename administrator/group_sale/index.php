    ...
    <TABLE>
      <THEAD>
        <TR>
          ...
          <TH width="6%" <?php  Show_Sort_bg ("user_id", $orderby) ?>> <?php 
		$a_not_exists = array('orderby','sortby');
		$param2 = get_param($a_param,$a_not_exists);
	?>
            <?php   Show_Sort_new ("user_id", "ลำดับ.", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="13%"><?php   Show_Sort_new ("group_cus_id", "รหัสพนักงานขาย", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="45%"> <?php   Show_Sort_new ("group_name", "ชื่อพนักงานขาย", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
