<?php 
	...
	$a_param = array('page','orderby','sortby','keyword','pagesize','user_id');
	...
	//if ($_REQUEST['mode'] <> "") { 
		...
		if ($_REQUEST[option] == "Add") { 
			...
			// filedlist(user_id,module_id,read_p,add_p,update_p,delete_p)
			$sql = "insert into s_user_p (user_id,module_id,read_p,add_p,update_p,delete_p) values ";
			$sql.= "('".$_POST['user_id']."',".$_POST['module_id'].",".$_POST['read_p'].",".$_POST['add_p'].",".$_POST['update_p'].",".$_POST['delete_p'].")";
			@mysqli_query($conn,$sql);
			header ("location:?" . $param); 
		}
		if ($_REQUEST[option] == "Edit" ) { 
			//include ("../include/m_update.php");
			$sql = "update s_user_p  set user_id = '".$_POST['user_id']."',module_id = ".$_POST['module_id'].",read_p = ".$_POST['read_p'].",add_p = ".$_POST['add_p'].",update_p = ".$_POST['update_p'].",delete_p = ".$_POST['delete_p'].", update_date = '".date("Y-m-d H:i:s")."', update_by= '".$_SESSION['login_id']."' where user_p_id = ".$_REQUEST['user_p_id']." ";
			@mysqli_query($conn,$sql);
			header ("location:?" . $param); 
		}
//	}
