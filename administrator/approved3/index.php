<?php
	...
	if($_GET['action'] == "update"){
		...
		if ($code == "1") {
			header ("location:update.php?mode=update&id=".$_GET['id']);
		} 
	}
	...
	if($_GET['action'] == "reject"){
		$code = Check_Permission($conn,$check_module,$_SESSION["login_id"],"update");		
		if ($code == "1") {
			header ("location:reject.php?mode=update&id=".$_GET['id']);
		} 
	}
    ...
    <TABLE>
      <THEAD>
        <TR>
          ...
          <TH width="15%"><div align="center"><a>Memo ID</a></div></TH>
<!--
          <TH width="15%"><div align="center"><a>ชื่อลูกค้า</a></div></TH>
           <TH width="15%"><div align="center"><a>ที่อยู่</a></div></TH>
-->
          <TH width="15%"><div align="center"><a>Memo โดย</a></div></TH>
		  <TH width="15%"><div align="center"><a>Memo วันที่</a></div></TH>
		  <TH width="15%"><center><strong>เอกสาร</strong></center></TH>
<!--
...
//						$row_sr2 = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM s_quotation_jobcard2 WHERE srid= '".$rec['qc_id']."'"));
        ...
        <TR>
          ...
          <TD style="vertical-align:middle;"><?php  $chaf = str_replace("/","-",$rec["mo_id"]); ?><div align="center"><span class="text"><a href="../../upload/memo/<?php  echo $chaf;?>.pdf" target="_blank"><?php  echo $rec["mo_id"] ; ?></a></span></div></TD>
<!--
          <TD style="vertical-align:middle;"><div align="center"><span class="text">
          	<?php echo $quinfo['cd_name'];?>
          </span></div></TD>
          <TD style="vertical-align:middle;"><div align="center"><span class="text">
          	<?php echo $quinfo['cd_address'];?>
          </span></div></TD>
-->
          <TD style="vertical-align:middle;"><center><span class="text"><?php echo getsalename($conn,$rec["cs_sell"]);?></span></center></TD>
           <TD style="vertical-align:middle;"><center><span class="text"><?php echo format_date_th($rec["memo_open"],2);?></span></center></TD>
<!--
          <TD style="vertical-align:middle"><div align="center">
            <?php  if($rec["st_setting"]==0) {?>
            <a href="../memo/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["st_setting"]; ?>&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&id=<?php  echo $rec["qu_id"];?>&tab=<?php echo $rec["qu_table"];?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../memo/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["st_setting"]; ?>&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&id=<?php  echo $rec["qu_id"];?>&tab=<?php echo $rec["qu_table"];?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php  }?>
          </div></TD>
          ...
          <TD style="vertical-align:middle;"><div align="center"><A title=Delete  href="#"><IMG alt=Delete src="../images/cross.png" onClick="confirmDelete('?action=delete&id=<?php  echo $rec["qu_id"];?>&tab=<?php echo $rec["qu_table"];?>&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field];?>','Group  <?php  echo $rec[$PK_field];?> : <?php  echo $rec["mo_id"];?>')"></A></div></TD>
-->
		 <td style="vertical-align: middle;">
			  <center><a href="../document_check/?fo_id=<?php  echo $rec[$PK_field];?>&target=MEMO"><img src="../images/document.png" height="30"></a></center>
		  </td>
         
         <td>
         	<center><A title="Approved" href="#" onClick="confirmApprove('?action=update&mode=update&id=<?php  echo $rec[$PK_field];?>','<?php  echo $rec["mo_id"];?>')"><IMG alt="Approved" src="../images/approved.png" width="30"></A></center>
         </td>
         <td>
         	<center><A title="Rejected" href="#" onClick="confirmReject('?action=reject&mode=update&id=<?php  echo $rec[$PK_field];?>','<?php  echo $rec["mo_id"];?>')"><IMG alt="Rejected" src="../images/cross.png" width="30"></A></center>
         </td>
          </TR>
		<?php  }?>
      </TBODY>
