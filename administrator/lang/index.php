...
<UL class=shortcut-buttons-set>
  <LI><A class=shortcut-button href="update.php?mode=add<?php  if ($param <> "") echo "&".$param; ?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>Add New</SPAN></A></LI>
    <?php  
	if ($FR_module <> "") { 
...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
	...
	?>
            ...
            &nbsp;</TH>
          <TH width="13%" nowrap><a>Image</a></TH>
          <TH width="23%" <?php  Show_Sort_bg ("name", $orderby) ?>> <?php   Show_Sort_new ("lang_name", "Lang Name", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="17%" <?php  Show_Sort_bg ("name", $orderby) ?>> <?php   Show_Sort_new ("lang_key", "Lang Key", $orderby, $sortby,$page,$param2);?>
  &nbsp;</TH>
          <TH width="15%" nowrap><div align="center"><a>Folder</a></div></TH>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align:middle"><?php  
			$part_img="../../upload/lang/".$rec['lang_images'];
