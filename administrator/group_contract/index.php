	...
	?>
          ...
          <TH width="17%" <?php  Show_Sort_bg ("group_name", $orderby) ?>>
           <?php   Show_Sort_new ("group_name", "รหัส", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="55%" <?php  Show_Sort_bg ("group_name", $orderby) ?>> <?php   Show_Sort_new ("group_name", "รายการแจ้งซ่อม", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD><span class="text"><?php  echo $rec["group_con_id"] ; ?></span></TD>
