...
<head>
	...
	<script type="text/javascript">
		function get_customer(cid, cname) {
			...
			self.opener.checkfirstorder(cid, 'cusadd', 'cusprovince', 'custel', 'cusfax', 'contactid', 'datef', 'datet', 'cscont', 'cstel', 'sloc_name', 'sevlast', 'prolist', 'sr_ctype2', 'loc_clean', 'loc_clean_sn');
