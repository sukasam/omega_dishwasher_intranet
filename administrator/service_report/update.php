  ...
  <form action="update.php" method="post" enctype="multipart/form-data" name="form1" id="form1"  onSubmit="return check(this)">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
            	...
            	<select name="sr_ctype2" id="sr_ctype2">
            	  ...
            	  <?php  
						...
						while($row_cusftype2 = @mysqli_fetch_array($qu_cusftype2)){
							...
							if($row_cusftype2['group_cus_code'] == "SR" || $row_cusftype2['group_cus_code'] == "IR" || $row_cusftype2['group_cus_code'] == "RR" || $row_cusftype2['group_cus_code'] == "MR"){
							?>
          ...
          <tr>
            ...
            <td><strong>เลขที่บริการ : <input type="text" name="sv_id" value="<?php  if($sv_id == ""){echo check_servicereport($conn);}else{echo $sv_id;};?>" id="sv_id" class="inpfoder" style="border:0;">&nbsp;&nbsp;เลขที่สัญญา  :</strong> <span id="contactid"><?php  echo $finfo['fs_id'];?></span></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><strong>สถานที่ติดตั้ง / ส่งสินค้า : </strong><span id="sloc_name"><?php  echo $finfo['loc_name'];?></span><br />
          ...
          <br />
            ...
            <strong>เครื่องป้อนน้ำยา : </strong><input type="text" name="loc_clean" value="<?php  echo $loc_clean;?>" id="loc_clean" class="inpfoder" style="width:20%;">&nbsp;<strong>S/N</strong>&nbsp;<span id="lpa3"><input type="text" name="loc_clean_sn" value="<?php  echo $loc_clean_sn;?>" id="loc_clean_sn" class="inpfoder" style="width:20%;"></span><br />
            <br>
