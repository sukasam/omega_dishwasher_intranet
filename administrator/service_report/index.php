...
-->
          ...
          <TD style="vertical-align:middle;"><!-- Icons -->
            <div align="center"><A title=Edit href="update2.php?mode=update&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field]; if($param <> "") {?>&<?php  echo $param; }?>"><IMG src="../images/icons/paper_content_pencil_48.png" alt=Edit width="25" height="25" title="แก้ไขรายงานแจ้งซ่อม"></A><a href="../../upload/service_report_close/<?php  echo $chaf;?>.pdf" target="_blank"><img src="../images/icon2/backup.png" width="25" height="25" title="ดาวน์โหลดรายงานช่างซ่ิอม" style="margin-left:10px;"></a><?php if($rec['latitude'] != '' && $rec['longitude'] != ""){?><br><a href="https://www.google.co.th/maps/search/<?php echo $rec['latitude'];?>+<?php echo $rec['longitude'];?>" target="_blank"><img src="../images/google_map.png" width="25"></a><?php }?></div></TD>
