...
<!--          <TH width="8%"><div align="center"><a>การยืนยัน</a></div></TH>-->
          ...
          <TH width="10%"><div align="center"><a>วันที่บริการ</a></div></TH>
...
-->
          ...
          <TD style="vertical-align:middle;"><!-- Icons -->
            <div align="center"><A title=Edit href="update2.php?mode=update&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field]; if($param <> "") {?>&<?php  echo $param; }?>"><IMG src="../images/icons/paper_content_pencil_48.png" alt=Edit width="25" height="25" title="แก้ไขรายงานแจ้งซ่อม"></A><a href="../../upload/service_report_close/<?php  echo $chaf;?>.pdf" target="_blank"><img src="../images/icon2/backup.png" width="25" height="25" title="ดาวน์โหลดรายงานช่างซ่ิอม" style="margin-left:10px;"></a>
          ...
          <TD style="vertical-align:middle;text-align: center;"> <?php if($rec['latitude'] != '' && $rec['longitude'] != ""){echo "<br>".getCustomerSignatureDateTime($conn,$rec[$PK_field]);}else{echo '-';}?></TD>
