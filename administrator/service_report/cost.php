      ...
      <div style="margin-bottom: 30px;">
		  ...
		  <tbody>
			<tr>
			  ...
			  <p>
			    <strong>ค่าติดตั้ง (ถอด/เปลี่ยน/ย้าย)</strong><br>
			  	<input type="radio" name="setup" value="" <?php if($setup == ""){echo 'checked';}?> class="fakeRadio"> <input type="text" name="setupP" value="<?php echo $setupP;?>" style="width: 60px;text-align: right;" onkeypress="return isNumberKey(event)"> บาท (ก่อนเที่ยงคืน)<br>
			  	...
			  	<input type="radio" name="setup" value="0" <?php if($setup == '0'){echo 'checked';}?>> ไม่มีค่าติดตั้ง<br>
