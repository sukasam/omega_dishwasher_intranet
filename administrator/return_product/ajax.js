...
function checkfirstorder(pval, param1, param2, param3, param4, param5, param6, param7) {
    var xmlHttp;
    ...
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
            ...
            document.getElementById("type_servicetxt").innerHTML = ds[8];
            document.getElementById("ship_name").value = ds[9];
            document.getElementById("ship_address").value = ds[10];
            document.getElementById("cs_sell").value = ds[11];
            document.getElementById("fo_product").innerHTML = ds[12];
        } else {
