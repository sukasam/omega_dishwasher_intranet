...
<UL class=shortcut-buttons-set>
  ...
  <?php  }?> 
  <LI><A class=shortcut-button href="../return_product/index.php?"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
  กลับ</SPAN></A></LI>
</UL>
      ...
      <TBODY>
        <?php  
					...
					if ($sortby =="") $sortby ="DESC";
				   	...
				   	$sql = "SELECT sr . * , fd.cd_name FROM $tbl_name AS sr, s_return_product AS fd WHERE sr.cus_id = fd.order_id AND sr.cus_id ='".$_GET['order_id']."'";
