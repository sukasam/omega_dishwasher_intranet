  ...
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
	...
	?>
          ...
          <TH width="17%" <?php  Show_Sort_bg ("group_name", $orderby) ?>>
           <?php   Show_Sort_new ("group_name", "รหัสประเภทสินค้า", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="55%" <?php  Show_Sort_bg ("group_name", $orderby) ?>> <?php   Show_Sort_new ("group_name", "ชื่อประเภทสินค้า", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
