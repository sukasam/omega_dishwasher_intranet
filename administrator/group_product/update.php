        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td><table class="formFields" cellspacing="0" width="100%">
              <tr >
                <td nowrap class="name">รหัสประเภทสินค้า</td>
                <td><input name="group_pro_id" type="text" id="group_pro_id"  value="<?php  echo $group_pro_id; ?>" size="60"></td>
              </tr>
              <tr >
                <td nowrap class="name">ชื่อประเภทสินค้า</td>
