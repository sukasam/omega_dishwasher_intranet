...
function checkfirstorder(pval,param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13,param14,param15){
	var xmlHttp;
   ...
   if (xmlHttp==null){
    ...
    xmlHttp.onreadystatechange=function (){
        if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){   
			...
			document.getElementById(param14).value=ds[14];
			document.getElementById(param15).value=ds[15];
        } else{
