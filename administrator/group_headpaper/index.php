								...
								<THEAD>
									<TR>
										...
										<TH width="10%" <?php Show_Sort_bg("user_id", $orderby) ?>> <?php
											...
											&nbsp;</TH>
										<TH width="20%" <?php Show_Sort_bg("group_key", $orderby) ?>>
											<?php Show_Sort_new("group_name", "Keys", $orderby, $sortby, $page, $param2); ?>
											&nbsp;</TH>
										<TH width="50%" <?php Show_Sort_bg("group_name", $orderby) ?>> <?php Show_Sort_new("group_name", "รายการ", $orderby, $sortby, $page, $param2); ?>
											&nbsp;</TH>
								...
								<TBODY>
									...
									?>
										<TR>
											...
											<TD><span class="text"><?php echo $rec["group_key"]; ?></span></TD>
