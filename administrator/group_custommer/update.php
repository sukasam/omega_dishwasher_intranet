        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td><table class="formFields" cellspacing="0" width="100%">
              <tr >
                <td nowrap class="name">รหัสประเภทลูกค้า</td>
                <td><input name="group_cus_id" type="text" id="group_cus_id"  value="<?php  echo $group_cus_id; ?>" size="60"></td>
              </tr>
              <tr >
                <td nowrap class="name">รหัสประเภทลูกค้า</td>
                <td><input name="group_cus_code" type="text" id="group_cus_code"  value="<?php  echo $group_cus_code; ?>" size="60"></td>
              </tr>
              <tr >
                <td nowrap class="name">ชื่้อประเภทลูกค้า</td>
