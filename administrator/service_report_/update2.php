  ...
  <form action="update2.php" method="post" enctype="multipart/form-data" name="form1" id="form1"  onSubmit="return check(this)">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
	  ...
	  <tr>
	    ...
	    <td><strong>เลขที่บริการ  :</strong><input type="text" name="sv_id" value="<?php  if($sv_id == ""){echo check_servicereport("SR".date("Y/m/"));}else{echo $sv_id;};?>" id="sv_id" class="inpfoder" readonly style="border:0;">&nbsp;&nbsp;<strong>เลขที่สัญญา  :</strong><span id="contactid"><?php  echo $finfo['fs_id'];?></span></td>
	    </tr>
	  <tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <select name="cpro2" id="cpro2" class="inputselect" style="width:100%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php 
              $qupro2 = @mysql_query("SELECT * FROM s_group_sparpart ORDER BY group_name ASC");
              while($row_qupro2 = @mysql_fetch_array($qupro2)){
                ?>
