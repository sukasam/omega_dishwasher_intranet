<?php
	...
	if($_GET['action'] == "update"){
		...
		if ($code == "1") {
			header ("location:update.php?mode=update&qc_id=".$_GET['qc_id']);
		} 
	}
	...
	if($_GET['action'] == "reject"){
		$code = Check_Permission($conn,$check_module,$_SESSION["login_id"],"update");		
		if ($code == "1") {
			header ("location:reject.php?mode=update&qc_id=".$_GET['qc_id']);
		} 
	}
    ...
    <TABLE>
      <THEAD>
        <TR>
          ...
          <TH width="15%"><div align="center"><a>เลขที่ใบแจ้งงาน</a></div></TH>
...
-->
         ...
         <td>
         	<center><A title="Approved" href="#" onClick="confirmApprove('?action=update&mode=update&qc_id=<?php  echo $rec[$PK_field];?>','<?php  echo $rec["sv_id"];?>')"><IMG alt="Approved" src="../images/approved.png" width="30"></A></center>
         </td>
         <td>
         	<center><A title="Rejected" href="#" onClick="confirmReject('?action=reject&mode=update&qc_id=<?php  echo $rec[$PK_field];?>','<?php  echo $rec["sv_id"];?>')"><IMG alt="Rejected" src="../images/cross.png" width="30"></A></center>
         </td>
          </TR>
		<?php  }?>
      </TBODY>
