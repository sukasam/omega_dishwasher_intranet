...
if ($_GET['act'] == "return") {
	...
	if ($copydb5['sr_id'] != $_GET['sr_id']) {
		...
		//			echo "INSERT INTO `s_service_report5` (`sr_id`, `sv_id`, `cus_id`, `sr_ctype`, `sr_ctype2`, `job_open`, `job_close`, `job_balance`, `sr_stime`, `loc_pro`, `loc_seal`, `loc_sn`, `loc_clean`, `loc_contact`, `loc_contact2`, `loc_contact3`, `cs_sell`, `loc_tels`, `cl_01`, `cl_02`, `cl_03`, `cl_04`, `cl_05`, `cl_06`, `cl_07`, `cl_08`, `ckl_list`, `ckw_list`, `ckf_list`, `detail_recom`, `detail_recom2`, `detail_calpr`, `approve`, `supply`, `approve_return`, `st_setting`, `loc_date2`, `sell_date`, `loc_date3`, `create_by`, `create_date`, `update_by`, `update_date`, `delete_by`, `delete_date`) VALUES ('".$copydb['sr_id']."', '".$copydb['sv_id']."', '".$copydb['cus_id']."', '".$copydb['sr_ctype']."', '".$copydb['sr_ctype2']."', '".$copydb['job_open']."', '".$copydb['job_close']."', '".$copydb['job_balance']."', '".$copydb['sr_stime']."', '".$copydb['loc_pro']."', '".$copydb['loc_seal']."', '".$copydb['loc_sn']."', '".$copydb['loc_clean']."', '".$copydb['loc_contact']."', '".$copydb['loc_contact2']."', '".$copydb['loc_contact3']."', '".$copydb['cs_sell']."', '".$copydb['loc_tels']."', '".$copydb['cl_01']."', '".$copydb['cl_02']."', '".$copydb['cl_03']."', '".$copydb['cl_04']."', '".$copydb['cl_05']."', '".$copydb['cl_06']."', '".$copydb['cl_07']."', '".$copydb['cl_08']."', '".$copydb['ckl_list']."', '".$copydb['ckw_list']."', '".$copydb['ckf_list']."', '".$copydb['detail_recom']."', '".$copydb['detail_recom2']."', '".$copydb['detail_calpr']."', '".$copydb['approve']."', '0', '0', '".$copydb['st_setting']."', '".$copydb['loc_date2']."', '".$copydb['sell_date']."', '".$copydb['loc_date3']."', '".$copydb['create_by']."', '".$copydb['create_date']."', '".$copydb['update_by']."', '".$copydb['update_date']."', '".$copydb['delete_by']."', '".$copydb['delete_date']."');";
		//			exit();
								...
								<THEAD>
									<TR>
										...
										<TH width="5%" <?php Show_Sort_bg("user_id", $orderby) ?>> <?php
											...
											&nbsp;</TH>
										<TH width="9%">
											<div align="center"><a>LP ID</a></div>
										</TH>
										...
										<TH width="16%">
											<div align="center"><a>คืนอะไหล่</a></div>
										</TH>
										<TH width="8%">
					...
					break;*/
									...
									?>
										<TR>
											...
											<TD style="vertical-align:middle;">
												<div align="center"><A href="index.php?act=return&sr_id=<?php echo $rec["sr_id"]; ?>"><IMG alt=icon src="../images/icons/icon-48-install.png"></A></div>
											</TD>
											<TD style="vertical-align:middle">
												<div align="center">
											...
											<TD style="vertical-align:middle;">
												...
												<div align="center"><A title=Edit href="update.php?mode=update&<?php echo $PK_field; ?>=<?php echo $rec[$PK_field];
																																			if ($param <> "") { ?>&<?php echo $param;
																																														} ?>"><IMG src="../images/icons/paper_content_pencil_48.png" alt=Edit width="25" height="25" title="แก้ไขรายงานแจ้งซ่อม"></A><a href="../../upload/service_report_open/<?php echo $chaf; ?>.pdf" target="_blank"><img src="../images/icon2/backup.png" width="25" height="25" title="ดาวน์โหลดรายงานช่างซ่ิอม" style="margin-left:10px;"></a></div>
											</TD>
											<TD style="vertical-align:middle;">
