<?php 
	...
	if($_GET['action'] == "update"){
		...
		if ($code == "1") {
			header ("location:update.php?mode=update&fo_id=".$_GET['fo_id']."&page=".$_GET['page']);
		} 
	}
	...
	if($_GET['action'] == "reject"){
		$code = Check_Permission($conn,$check_module,$_SESSION["login_id"],"update");		
		if ($code == "1") {
			header ("location:reject.php?mode=update&fo_id=".$_GET['fo_id']."&page=".$_GET['page']);
		} 
	}
...
<!--          <TD><INPUT type=checkbox name="del[]" value="<?php  echo $rec[$PK_field]; ?>" ></TD>-->
          ...
          <td style="vertical-align: middle;">
			  <center><a href="../document_check/?fo_id=<?php  echo $rec[$PK_field];?>&target=FO"><img src="../images/document.png" height="30"></a></center>
		  </td>
...
<!--          <TD><div align="center"><a href="../../upload/first_order/<?php  echo $chaf;?>.pdf" target="_blank"><img src="../images/icon2/download_f2.png" width="20" height="20" border="0" alt=""></a></div></TD>-->
          ...
          <TD>
<!--          <center><A title="Edit" href="#" onClick="confirmApprove('update.php?mode=update&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field]; if($param <> "") {?>&<?php  echo $param; }?>,Approved FO ID: <?php  echo $rec["fs_id"];?> ')"><IMG alt="Edit" src="../images/approved.png" width="30"></A></center>  -->
         
         <center><A title="Approved" href="#" onClick="confirmApprove('?action=update&mode=update&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field]; if($param <> "") {?>&<?php  echo $param; }?>','<?php  echo $rec["fs_id"];?>')"><IMG alt="Edit" src="../images/approved.png" width="30"></A></center>
         
          </TD>
          <td>
          	<center><A title="Rejected" href="#" onClick="confirmReject('?action=reject&mode=reject&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field]; if($param <> "") {?>&<?php  echo $param; }?>','<?php  echo $rec["fs_id"];?>')"><IMG alt="Rejected" src="../images/cross.png" width="30"></A></center>
          </td>
