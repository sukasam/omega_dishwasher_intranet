...
//			//exit();
	...
	if($_GET['action'] == "createQA"){
		$sql = "SELECT * FROM s_quotation3 where qu_id = '".$_GET['id']."'";
		...
		@mysqli_query($conn,"INSERT INTO 
									`s_quotation32` (`cd_name`,`cd_address`,`cd_province`,`cd_tel`,`cd_fax`,`fs_id`,`date_forder`,`pro_type`,
		...
		mysqli_query($conn,"UPDATE `s_quotation32` SET `quotation` = '".$_GET['id']."' WHERE `qu_id` = ".$idQa.";");
		mysqli_query($conn,"UPDATE `s_quotation3` SET `quotation` = '".$idQa."' WHERE `qu_id` = ".$_GET['id'].";");
			  	...
			  	<center><a href="../quotation_jobcard/?tab=1&id=<?php  echo $rec[$PK_field]; ?>"><img src="../images/hammer_screwdriver.png" width="20" height="20"></a></center>
					...
					<TD style="text-align: center;"><?php
						if($rec["quotation"] != ""){
							...
							?>
							<a href="../quotation3/?action=createQA&id=<?php  echo $rec[$PK_field]; ?>"><img src="../images/paper_content_pencil_48.png" width="20" height="20"></a>
							<?php
						}
					?></TD>
-->
            ...
            <a href="../quotation3/?ff=<?php  echo $rec[$PK_field]; ?>&gg=0&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>"><img src="../icons/favorites_use.png" width="15" height="15"> | </a>
            <a href="../quotation3/?ff=<?php  echo $rec[$PK_field]; ?>&gg=1&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>"><img src="../icons/favorites_stranby.png" width="15" height="15"> | </a>
            <a href="../quotation3/?ff=<?php  echo $rec[$PK_field]; ?>&gg=2&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>"><img src="../icons/favorites_close.png" width="15" height="15"></a>
            </div>
          </div></TD>
          <!--<TD nowrap style="vertical-align:middle;display: none;"><div align="center">
            <?php  if($rec["status"]==0) {?>
            <a href="../quotation3/?bb=<?php  echo $rec[$PK_field]; ?>&ss=<?php  echo $rec["status"]; ?>&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&foid=<?php  echo $rec["qu_id"]; ?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../quotation3/?bb=<?php  echo $rec[$PK_field]; ?>&ss=<?php  echo $rec["status"]; ?>&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&foid=<?php  echo $rec["qu_id"]; ?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
...
<!--
          <TD nowrap style="vertical-align:middle"><div align="center">
            ...
            <a href="../quotation3/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["st_setting"]; ?>&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../quotation3/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["st_setting"]; ?>&page=<?php  echo $_GET['page']; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  }?>
          </div></TD>
-->
