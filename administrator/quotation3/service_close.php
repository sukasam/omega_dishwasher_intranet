...
<UL class=shortcut-buttons-set>
  ...
  <?php  }?> 
  <LI><A class=shortcut-button href="../quotation3/index.php?"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
  กลับ</SPAN></A></LI>
</UL>
      ...
      <TBODY>
        <?php  
					...
					if ($sortby =="") $sortby ="DESC";
				   	...
				   	$sql = "SELECT sr . * , fd.cd_name FROM $tbl_name AS sr, s_quotation3 AS fd WHERE sr.cus_id = fd.qu_id AND sr.cus_id ='".$_GET['qu_id']."'";
