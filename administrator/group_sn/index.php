...
<UL class=shortcut-buttons-set>
 <LI><A class=shortcut-button href="../group_pod/"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR><br>
  กลับ</SPAN></A></LI>
  <LI><A class=shortcut-button href="update.php?mode=add<?php  if ($param <> "") echo "&".$param; ?>&pod=<?php echo $_GET['pod'];?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
    เพิ่ม</SPAN></A></LI>
    <?php  
	if ($FR_module <> "") { 
