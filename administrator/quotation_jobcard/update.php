<?php 
	...
	if ($_POST['mode'] <> "") { 
		...
		if ($_POST['mode'] == "add") { 
			...
			if($_POST['sv_id'] == ""){
				 $_POST['sv_id'] = check_servicecard($conn);
			}
			...
			header ("location:index.php?tab=".$_REQUEST['qu_table']."&id=".$_REQUEST['qu_id']); 
		}
...
-->
    ...
    <div class="formArea">
      ...
      <input name="qu_id" type="hidden" id="qu_id" value="<?php  echo $_GET['cus_id'];?>"> 
      <input name="qu_table" type="hidden" id="qu_table" value="<?php  echo $_GET['tab'];?>"> 
