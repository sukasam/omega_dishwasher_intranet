    ...
    <TABLE>
      <THEAD>
        <TR>
          ...
          <TH width="0%" <?php  Show_Sort_bg ("user_id", $orderby) ?>> <?php 
		$a_not_exists = array('orderby','sortby');
		$param2 = get_param($a_param,$a_not_exists);
	?>
            <?php   Show_Sort_new ("user_id", "ลำดับ.", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="100%" <?php  Show_Sort_bg ("group_name", $orderby) ?>>
           <?php   Show_Sort_new ("group_name", "ชื่อกลุ่ม", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="0%" nowrap <?php  Show_Sort_bg ("create_date", $orderby) ?>>
           <?php   Show_Sort_new ("create_date", "สร้างเมื่อ", $orderby, $sortby,$page,$param2);?>
  &nbsp;</TH>
          <TH width="0%" nowrap><div align="center"><a>การอนุญาต</a></div></TH>
          <TH width="0%"><a>แก้ไข</a></TH>
          <TH width="0%"><a>ลบ</a></TH>
        </TR>
      </THEAD>
      <TFOOT>
        </TFOOT>
      <TBODY>
        ...
        <TR>
          ...
          <TD align="center"><div align="center"><a href="permission.php?mode=update&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field]; if($param <> "") {?>&<?php  echo $param; }?>"><img src="../images/icons/hammer_screwdriver.png" width="16" height="16" border="0"></a></div></TD>
          <TD><!-- Icons -->
