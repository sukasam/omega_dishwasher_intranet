<?php 
	...
	if($_REQUEST['action'] == "delete"){
		...
		if ($code == "1") {
			...
			header ("location:index.php?".$param."&fo_id=".$_GET['fo_id']."&target=".$_GET['target']."&cus_id=".$_GET['cus_id']); 
		} 
	}
	//-------------------------------------------------------------------------------------
...
<?php  include('../top.php');?>
<P id=page-intro><?php  echo ucfirst ($page_name); ?> <!--  | <a href="../document_memo/tag.php?mid=<?php  echo $_GET['mid'];?>">Tag Keyword</a>--></P>

<UL class=shortcut-buttons-set>
<LI><A class=shortcut-button href="../memo/index.php?cus_id=<?php echo $_GET['cus_id'];?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR><BR>Back</SPAN></A></LI>
  <LI><A class=shortcut-button href="../document_memo/update.php?mode=add<?php  if ($param <> "") echo "&".$param;?><?php  if(isset($_GET['fo_id'])){echo '&fo_id='.$_GET['fo_id'];}?><?php  if(isset($_GET['target'])){echo '&target='.$_GET['target'];}?>&cus_id=<?php echo $_GET['cus_id'];?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
...
<div>
 ...
 <form name="form1" method="get" action="../document_memo/index.php">
  <input name="keyword" type="text" id="keyword" value="<?php  echo $_GET['keyword'];?>">
    ...
    <?php 
			...
			$param2 = get_param($a_param,$a_not_exists);*/
			  ?>
    <a href="../document_memo/index.php?fo_id=<?php echo $_GET['fo_id'];?>&target=<?php echo $_GET['target'];?>&cus_id=<?php echo $_GET['cus_id'];?>">Show All</a>
    <?php  
			/*$a_not_exists = array();
...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="../document_memo/confirm.php" onSubmit="return check_select(this)">
    <TABLE>
      <THEAD>
        <TR>
...
<!--
          <TD nowrap style="vertical-align:middle"><div align="center">
            <?php  if($rec["status"]==0) {?>
            <a href="../document_memo/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["status"]; ?>&fo_id=<?php echo $_GET['fo_id'];?>&page=<?php  echo $page; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&<?php  echo $param2;?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../document_memo/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["status"]; ?>&fo_id=<?php echo $_GET['fo_id'];?>&page=<?php  echo $page; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&<?php  echo $param2;?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php  }?>
          </div></TD>
-->
        
          <TD style="vertical-align:middle">
            <A title=Edit href="../document_memo/update.php?mode=update&fo_id=<?php echo $_GET['fo_id'];?>&target=<?php echo $_GET['target'];?>&cus_id=<?php echo $_GET['cus_id'];?>&<?php  echo $PK_field; ?>=<?php  echo $rec["$PK_field"]; if($param <> "") {?>&<?php  echo $param; }?>"><IMG alt=Edit src="../images/pencil.png"></A> <A title=Delete  href="#"></A></TD>
          <TD style="vertical-align:middle"><A title=Delete  href="#"><IMG alt=Delete src="../images/cross.png" onClick="confirmDelete('?action=delete&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field];?>&del_id=<?php  echo $rec['id'];?>&del_img=<?php  echo $rec['images'];?>&fo_id=<?php  echo $_GET['fo_id'];?>&target=<?php echo $_GET['target'];?>&cus_id=<?php echo $_GET['cus_id'];?>','<?php  echo $title_del;?>  <?php  echo $rec[$PK_field];?> : <?php  echo $rec[$title_del_name];?>')"></A></TD>
        </TR>  
		<?php  }?>
      </TBODY>
    </TABLE>
