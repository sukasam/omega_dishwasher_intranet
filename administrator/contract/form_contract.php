...
<?php 
	...
	for($i=1;$i<=5;$i++){
		if($finfos['cs_pro'.$i]){
			$runPro++;
			$listProFree .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.'.$runPro.' '.$finfos['cs_pro'.$i].' จำนวน '.$finfos['cs_amount'.$i].'<br>';
			//$runPro++;
		}
	}
	...
	if($_POST['con_img1']){
		$imgPro .= '<img src="../../upload/contract/img/'.$_POST['con_img1'].'" height="660"><br>';
	}
	...
	<div class="conID">
	 ...
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>บริษัท โอเมก้า ดิชวอชเชอร์ (ประเทศไทย) จำกัด</strong> โดย <strong>นางอัญชลี อภิรักษ์โยธิน / นายคณวัฒน์ อภิรักษ์โยธิน</strong> กรรมการผู้มีอำนาจ สำนักงานตั้งอยู่เลขที่ 31 ซอยโชคชัย 4 ซอย 50 แยก 4 ถนนโชคชัย 4 แขวงลาดพร้าว เขตลาดพร้าว กรุงเทพมหานคร 10230 เบอร์โทร 02-530-6357, 062-335-5285 แฟกซ์ 02-539-6842 ซึ่งต่อไปนี้สัญญานี้เรียกว่า “ ผู้ให้เช่า ” ฝ่ายหนึ่ง กับ<br>
	 
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>'.$finfos['cd_name'].'</strong> โดย <strong>'.$finfos['name_consign'].'</strong> กรรมการผู้มีอำนาจ สำนักงานใหญ่ตั้งอยู่เลขที่ '.$finfos['cd_address'].' โทรศัพท์ '.$finfos['cd_tel'].' ซึ่งต่อไปในสัญญานี้เรียกว่า “ผู้เช่า” อีกฝ่ายหนึ่ง<br><br>
	 
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 1. ข้อตกลงเช่า</strong><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ผู้เช่าตกลงเช่าและผู้ให้เช่าตกลงให้เช่า'.$nameConproCh.' ของ บริษัท โอเมก้า ดิชวอชเชอร์ (ประเทศไทย) จำกัด เพื่อใช้ล้างภาชนะใน '.$finfos['loc_name'].' ที่ตั้งร้านเลขที่ '.$finfos['loc_address'].'  โทรศัพท์ '.$finfos['cd_tel'].' ซึ่งต่อไปในสัญญานี้เรียกว่า “'.$nameConpro.'” ตามรายละเอียดแนบท้ายสัญญา<br><br>
	...
	หมายเหตุ : อุปกรณ์เสริมที่ทางผู้ให้เช่าให้ผู้เช่ายืม (หากอุปกรณ์ที่ยืมมีความเสียหายใด ๆ หรือมีการสูญหายเกิดขึ้น ทางผู้เช่าจะเป็นผู้รับผิดชอบทั้งหมดทุกกรณีโดยไม่มีเงื่อนไข)	<br><br>
	...
	<strong class="colorbBlue">(สัญญาเล่มนี้เป็นสัญญาปีที่ '.$numContract.' (ปีแรก ปี '.$contractFY.' เดือน '.$contractFM.') ตามเลขที่สัญญาเล่มแรก '.$contractFN.')</strong><br><br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 5. เงินประกัน</strong><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ในวันที่ทำสัญญา ผู้เช่าได้โอนเงินประกันเครื่องให้แก่ผู้ให้เช่า ดังนี้<br>
	
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.1 '.$nameConproCh.' เป็นจำนวนเงิน '.number_format($garunteePrice).' บาท ('.baht_text($garunteePrice).') และภาษีมูลค่าเพิ่ม 7% เป็นเงิน '.number_format($garunteeVat).' บาท ('.baht_text($garunteeVat).') <strong>รวมเป็นเงิน '.number_format($garunteeTotal).' บาท ('.baht_text($garunteeTotal).')</strong> มอบไว้แก่ผู้ให้เช่าเพื่อเป็นหลักประกันความเสียหาย ซึ่งอาจเกิดขึ้นกับ '.$nameConpro.'ที่เช่าและให้ปฏิบัติตามสัญญาดังนี้ หากผู้เช่า เช่าไม่ครบตามกำหนดระยะเวลา ในสัญญาหรือผิดสัญญาข้อใดข้อหนึ่ง ผู้เช่ายอมให้ผู้ให้เช่าริบเงินประกันเครื่องได้ทั้งหมด<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.2 เมื่อครบกำหนดระยะเวลาในการเช่าและผู้เช่าไม่ได้ผิดสัญญาหรือทำความเสียหายต่อ '.$nameConpro.'ข้อ 2 หรือติดค้างค่าเช่าและหรือค่าเสียหายใด ๆ ผู้ให้เช่ายินดีจะคืนเงินประกัน ตามวรรคแรกให้กับผู้เช่าโดยไม่มีดอกเบี้ยภายใน 30 วัน หลังจากรับคืน'.$nameConpro.' เรียบร้อยแล้ว<br><br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9.2  ผู้เช่าตกลงให้ผู้ให้เช่าหรือตัวแทนเข้าตรวจสอบและบำรุงรักษา'.$nameConpro.' ให้อยู่ในสภาพใช้งานได้ดี อยู่เสมอ โดยช่างผู้มีความรู้ความชำนาญและมีฝีมือดีมาตรวจสอบ บำรุงรักษาและซ่อมแซมแก้ไข '.$nameConpro.'ที่ให้เช่า ตลอดอายุสัญญาเช่านี้ อย่างน้อย '.$type_service.' เดือน/ครั้ง<br><br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ผู้ให้เช่าจะจัดอบรมวิธีการใช้เครื่องและการล้างภาชนะด้วยเครื่องให้แก่เจ้าหน้าที่ของผู้เช่าหลังการติดตั้ง โดยผู้เช่าจะต้องจัดเจ้าหน้าที่ วันเวลา สถานที่ ให้แก่ผู้ให้เช่าเข้าอบรม โดยผู้ให้เช่าจะไม่คิดค่าใช้จ่ายใด ๆ ถ้าผู้เช่าไม่จัดให้เจ้าหน้าที่เข้าอบรม หากเกิดความเสียหายขึ้น ผู้เช่าต้องรับผิดชอบตามสัญญาข้อที่ 9.1<br><br>
	...
	'.($numTop -= 1).'.1 ในกรณีผู้เช่าผิดนัดชำระค่าเช่า ผู้ให้เช่ามีสิทธิในการคิดดอกเบี้ยปรับในอัตราร้อยละ 2(สอง) ต่อเดือน ของค่าเช่าที่ค้างชำระจนกว่าผู้เช่าจะชำระครบและผู้ให้เช่าสามารถระงับการใช้งานของ'.$nameConpro.'ได้ หากผู้เช่าค้างชำระค่าเช่าเป็นเวลา 2 เดือน โดยไม่จำต้องบอกกล่าวทวงถาม<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	'.$numTop.'.2 ในกรณีที่ผู้เช่าผิดสัญญาข้อใดข้อหนึ่ง ผู้ให้เช่าจะแจ้งให้ผู้เช่าทราบเป็นลายลักษณ์อักษร เพื่อให้ผู้เช่าดำเนินการแก้ไขภายในระยะเวลา 30 วัน นับแต่วันที่ผู้เช่าได้รับการแจ้งเตือนและหากผู้เช่า ไม่ดำเนินการแก้ไขภายในระยะเวลาที่กำหนด ผู้ให้เช่ามีสิทธิบอกเลิกสัญญาได้ทันที แต่หากเป็นกรณีที่ ไม่อาจแก้ไขได้ผู้ให้เช่ามีสิทธิในการบอกเลิกสัญญาทันทีและเมื่อบอกเลิกสัญญาแล้ว ผู้ให้เช่ามีสิทธิริบเงินประกันทั้งหมดและให้ผู้ให้เช่ากลับเข้าครอบครองทรัพย์สินของผู้ให้เช่าได้ทันที โดยผู้ให้เช่ามีสิทธิดำเนินการถอดถอน'.$nameConpro.'ที่เช่าออกจากสถานที่ติดตั้งของผู้เช่าโดยถือว่าผู้เช่าอนุญาตให้ผู้ให้เช่าเข้าไปในสถานที่หรือร้านค้าของผู้เช่าหรือผู้เช่าต้องประสานและแจ้งเจ้าของสถานที่ทราบโดยถือว่าผู้เช่าอนุญาตให้เข้าไปโดยผู้เช่ายินยอมและกรณีผู้ให้เช่าเป็นฝ่ายถอดเครื่องออก หากการถอดถอนก่อให้เกิดความเสียหาย ผู้ให้เช่าจะเป็นผู้รับผิดชอบ แต่ถ้ากรณีผู้เช่าเป็นฝ่ายถอดเครื่องออกเอง หากเกิดความเสียหาย ผู้เช่าต้องเป็นฝ่ายรับผิดชอบ<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	'.$numTop++.'.3 ในกรณีผู้ให้เช่าผิดสัญญาทำผิดเงื่อนไขการเช่า ผู้เช่าสามารถบอกเลิกสัญญาล่วงหน้าอย่างน้อย 30 วัน และหากพบว่าเป็นความผิดจริง ให้ผู้ให้เช่าคืนเงินประกันให้ผู้เช่าภายใน 30 วัน เช่นกัน<br><br>
	
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ '.$numTop++.'.  การต่อสัญญาเช่า</strong><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;การเช่า'.$nameConpro.'ตามสัญญาเป็นการเช่าแบบมีกำหนดระยะเวลา ผู้ให้เช่าจะแจ้งการต่อสัญญาเช่า และการเปลี่ยนแปลงอัตราค่าเช่าใหม่ให้ผู้เช่าทราบก่อนครบกำหนดระยะเวลาเช่า 60 วัน หากเมื่อสัญญาครบระยะเวลาเช่าและยังไม่มีการต่อสัญญาหรือบอกยกเลิกสัญญาเช่าของทั้งสองฝ่าย ผู้ให้เช่าและผู้เช่าตกลงปฏิบัติตามเงื่อนไขในสัญญาเดิมโดยถือว่าคู่สัญญาตกลงทำสัญญากันใหม่โดยไม่มีกำหนดระยะเวลาจนกว่าจะมีการทำสัญญาใหม่หรือยกเลิกสัญญาเดิม<br><br></strong>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;margin-top:5px;">
      <tr>
        ...
        <td width="50%" class="signature" style="vertical-align: top;">
			...
			กรรมการผู้มีอำนาจ<br><br><br><br><br>
			ลงชื่อ………………………………………………พยาน<br><br>
			( นางวริษฐา อ่อนเลิศ )<br><br><br><br><br>
			ลงชื่อ………………………………………………พยาน<br><br>
			( นายฐิติศักดิ์  ฟักไพโรจน์ )<br>
        </td>
      </tr>
    </table>
	</div>
