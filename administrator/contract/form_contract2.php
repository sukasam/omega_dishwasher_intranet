...
//	}
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.2 เมื่อครบกำหนดระยะเวลาในการเช่าและผู้เช่าไม่ได้ผิดสัญญาหรือทำความเสียหายต่อ '.$nameConpro.'ข้อ 2 หรือติดค้างค่าเช่าและหรือค่าเสียหายใด ๆ ผู้ให้เช่ายินดีจะคืน'.$typegaruntree.' ตามวรรคแรกให้กับผู้เช่าโดยไม่มีดอกเบี้ยภายใน 30 วัน หลังจากรับคืน'.$nameConpro.' เรียบร้อยแล้ว<br><br>
