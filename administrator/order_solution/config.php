...
<?php 
	...
	$fieldlist = array('cd_name','cd_address','cd_province','ship_name','ship_address','cd_tel','cd_fax','fs_id','po_id','date_forder','type_service','c_contact','c_tel','remark','st_setting');
