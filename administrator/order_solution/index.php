							...
							<TABLE>
								<THEAD>
									<TR>
										...
										<TH width="12%">
											<div align="center"><a>เลขที่ใบสั่งน้ำยา</a></div>
										</TH>
										<TH width="35%">
											<div align="center"><a>ชื่อลูกค้า</a></div>
										</TH>
										<TH width="12%">
											<div align="center"><a>วันที่สั่งซื้อ</a></div>
										</TH>
										<TH width="12%">
											<div align="center"><a>ชื่อคนสั่งน้ำยา</a></div>
										</TH>
          ...
          <TH width="5%" nowrap ><div align="center"><a>เปิดใบเสนอราคาเช่า</a></div></TH> -->
								...
								<TBODY>
									...
									?>
										<TR>
											...
											<TD><?php $chaf = str_replace("/", "-", $rec["fs_id"]); ?><span class="text"><a href="../../upload/order_solution/<?php echo $chaf; ?>.pdf" target="_blank"><?php echo $rec["fs_id"]; ?></a></span></TD>
											...
											<TD> <center><span class="text"><?php echo get_username($conn,$rec['create_by']);?></span></center></TD>
											<!--			  <td>
			  	<center><a href="../quotation_jobcard/?tab=1&id=<?php echo $rec[$PK_field]; ?>"><img src="../images/hammer_screwdriver.png" width="20" height="20"></a></center>
					...
					<TD style="text-align: center;"><?php
							...
							<?php
														$file_pointer = '../../upload/order_solution/' . $chafQA . '.pdf';
														if (file_exists($file_pointer)) {
							?>
									| <a href="../../upload/order_solution/<?php echo $chafQA; ?>.pdf" target="_blank"><img src="../images/icon2/download_f2.png" width="20" height="20"></a>
									<?php
														}
									?>
							<?php
							...
							?>
							<a href="../order_solution/?action=createQA&id=<?php echo $rec[$PK_field]; ?>"><img src="../images/paper_content_pencil_48.png" width="20" height="20"></a>
							<?php
													}
							?></TD>
-->
            ...
            <a href="../order_solution/?ff=<?php echo $rec[$PK_field]; ?>&gg=0&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img src="../icons/favorites_use.png" width="15" height="15"> | </a>
            <a href="../order_solution/?ff=<?php echo $rec[$PK_field]; ?>&gg=1&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img src="../icons/favorites_stranby.png" width="15" height="15"> | </a>
            <a href="../order_solution/?ff=<?php echo $rec[$PK_field]; ?>&gg=2&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img src="../icons/favorites_close.png" width="15" height="15"></a>
            </div>
          </div></TD> -->
											<!--<TD nowrap style="vertical-align:middle;display: none;"><div align="center">
            <?php if ($rec["status"] == 0) { ?>
            <a href="../order_solution/?bb=<?php echo $rec[$PK_field]; ?>&ss=<?php echo $rec["status"]; ?>&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>&foid=<?php echo $rec["order_id"]; ?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else { ?>
            <a href="../order_solution/?bb=<?php echo $rec[$PK_field]; ?>&ss=<?php echo $rec["status"]; ?>&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>&foid=<?php echo $rec["order_id"]; ?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
          ...
          <div align="center"><A href="service_close.php?order_id=<?php echo $rec["order_id"]; ?>"><IMG  alt=icon src="../images/icons/icon-48-install.png"></A></div>
											...
											<!-- <TD><div align="center"><a href="../../upload/order_solution/<?php echo $chaf; ?>.pdf" target="_blank"><img src="../images/icon2/download_f2.png" width="20" height="20" border="0" alt=""></a></div></TD> -->
