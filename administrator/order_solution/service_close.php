...
<UL class=shortcut-buttons-set>
  ...
  <?php  }?> 
  <LI><A class=shortcut-button href="../order_solution/index.php?"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
  กลับ</SPAN></A></LI>
</UL>
...
<H3 align="left"><?php  echo $check_module. " ( ".get_foid($conn,$_GET['order_id'])." )"; ?></H3>
      ...
      <TBODY>
        <?php  
					...
					if ($sortby =="") $sortby ="DESC";
				   	...
				   	$sql = "SELECT sr . * , fd.cd_name FROM $tbl_name AS sr, s_order_solution AS fd WHERE sr.cus_id = fd.order_id AND sr.cus_id ='".$_GET['order_id']."'";
