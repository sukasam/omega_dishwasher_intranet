...
<UL class=shortcut-buttons-set>
  ...
  <?php  }?> 
  <LI><A class=shortcut-button href="../quotation2/index.php?"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
  กลับ</SPAN></A></LI>
</UL>
      ...
      <TBODY>
        <?php  
					...
					if ($sortby =="") $sortby ="DESC";
				   	...
				   	$sql = "SELECT sr . * , fd.cd_name FROM $tbl_name AS sr, s_quotation AS fd WHERE sr.cus_id = fd.qu_id AND sr.cus_id ='".$_GET['qu_id']."'";
