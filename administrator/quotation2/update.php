<?php
    ...
    $a_sdate=explode("/",$_POST['date_account']);
		...
		$_POST["paym"] = eregi_replace(",","",$_POST["paym"]);
		$_POST["pays"] = eregi_replace(",","",$_POST["pays"]);
		$_POST["paysa"] = eregi_replace(",","",$_POST["paysa"]);
		$_POST["paysad"] = eregi_replace(",","",$_POST["paysad"]);
		
		
		$_POST["sprice1"] = eregi_replace(",","",$_POST["sprice1"]);
		$_POST["sprice2"] = eregi_replace(",","",$_POST["sprice2"]);
		$_POST["sdisc1"] = eregi_replace(",","",$_POST["sdisc1"]);
    $_POST["sdisc2"] = eregi_replace(",","",$_POST["sdisc2"]);
...
if($_POST['spro1'] != ""){
  ...
  $totalSubSet1 = $_POST['sprice1'] * $_POST['sqty1'];
  if($_POST['sdisc1'] != ""){$totalSubSet1 = $totalSubSet1 - $_POST['sdisc1'];}
  else{$_POST['sdisc1'] = "";}
  $sumSetTotal = $sumSetTotal+$totalSubSet1;
  if($totalSubSet1 != "" || $totalSubSet1 != 0){
    $totalSubSet1s = number_format($totalSubSet1);
  }
}
...
if($_POST['spro2'] != ""){
  ...
  $totalSubSet2 = $_POST['sprice2'] * $_POST['sqty2'];
  if($_POST['sdisc2'] != ""){$totalSubSet2 = $totalSubSet2 - $_POST['sdisc2'];}
  else{$_POST['sdisc2'] = "";}
  $sumSetTotal = $sumSetTotal+$totalSubSet2;
  if($totalSubSet2 != "" || $totalSubSet2 != 0){
    $totalSubSet2s = number_format($totalSubSet2);
  }
}

$sumpriceSet  = $sumSetTotal;
$sumpricevatSet = ($sumpriceSet * 7) / 100;
$sumtotalsSet = $sumpriceSet + $sumpricevatSet;
	...
	if ($_GET[mode] == "add") {
		...
		$spro1 = "ค่าบริการขนส่ง/ติดตั้ง";
		$spro2 = "เงินประกันเครื่อง";
		$sqty1 = "1";
		$sqty2 = "1";
	}
	if ($_GET[mode] == "update") {
...
if($spro1 != ""){
  ...
  $totalSubSet1 = $sprice1 * $sqty1;
  if($sdisc1 != ""){$totalSubSet1 = $totalSubSet1 - $sdisc1;}
  else{$sdisc1 = "";}
  $sumSetTotal = $sumSetTotal+$totalSubSet1;
  if($totalSubSet1 != "" || $totalSubSet1 != 0){
    $totalSubSet1s = number_format($totalSubSet1);
...
if($spro2 != ""){
  ...
  $totalSubSet2 = $sprice2 * $sqty2;
  if($sdisc2 != ""){$totalSubSet2 = $totalSubSet2 - $sdisc2;}
  else{$sdisc2 = "";}
  $sumSetTotal = $sumSetTotal+$totalSubSet2;
  if($totalSubSet2 != "" || $totalSubSet2 != 0){
    $totalSubSet2s = number_format($totalSubSet2);
...
<UL class=shortcut-buttons-set>
  <LI><A class=shortcut-button href="../quotation2/"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
  กลับ</SPAN></A></LI>
</UL>
<!-- End .clear -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
          ...
          <tr>
            ...
            <input type="text" name="fs_id" value="<?php  if($fs_id == ""){echo check_quotation2("QA-H ".date("Y/m/"));}else{echo $fs_id;};?>" id="fs_id" class="inpfoder" > 
            </td>
          </tr>
          <tr>
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;padding:5;text-align:left;">
      	<select name="cpro3" id="cpro3" class="inputselect" style="width:90%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php
              $qupro3 = @mysql_query("SELECT * FROM s_group_typeproduct ORDER BY group_name ASC");
   ...
   <tr>
      ...
      <td style="border:1px solid #000000;padding:5;text-align:left;">
      	<select name="cpro4" id="cpro4" class="inputselect" style="width:90%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php
              $qupro4 = @mysql_query("SELECT * FROM s_group_typeproduct ORDER BY group_name ASC");
   ...
   <tr>
      ...
      <td style="border:1px solid #000000;padding:5;text-align:left;">
      	<select name="cpro5" id="cpro5" class="inputselect" style="width:90%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php
              $qupro5 = @mysql_query("SELECT * FROM s_group_typeproduct ORDER BY group_name ASC");
   ...
   <!--   <tr>
      ...
      <td style="border:1px solid #000000;padding:5;text-align:left;">
      	<select name="cpro6" id="cpro6" class="inputselect" style="width:90%;" >
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php
              $qupro6 = @mysql_query("SELECT * FROM s_group_typeproduct ORDER BY group_name ASC");
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;padding:5;text-align:left;">
      	<select name="cpro7" id="cpro7" class="inputselect" style="width:90%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php
              $qupro7 = @mysql_query("SELECT * FROM s_group_typeproduct ORDER BY group_name ASC");
          ...
          <tr>
            <td style="border:0;padding:0;width:60%;vertical-align:top;">
              ...
              <tr>
                <td width="3%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><strong>ลำดับ</strong></td>
                <td width="40%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><strong>รายการ</strong></td>
                <td width="12%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><strong>จำนวน</strong></td>
                <td width="15%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><strong>ราคา</strong></td>
                <td width="15%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><strong>ส่วนลด</strong></td>
                <td width="15%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><strong>ราคาสุทธิ</strong></td>
              </tr>
              <tr>
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">1</td>
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;"><input type="text" name="spro1" value="<?php  echo $spro1;?>" id="cs_pro1" class="inpfoder" style="width:90%;height:27px;"></td>
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><input type="text" name="sqty1" value="<?php  echo $sqty1;?>" id="cs_amount1" class="inpfoder" style="width:90%;text-align:center;height:27px;">
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><input type="text" name="sprice1" value="<?php  echo $sprice1;?>" id="cs_amount1" class="inpfoder" style="width:90%;text-align:center;height:27px;">
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><input type="text" name="sdisc1" value="<?php  echo $sdisc1;?>" id="cs_amount1" class="inpfoder" style="width:90%;text-align:center;height:27px;"></td>
                <td style="border:1px solid #000000;padding:5;text-align:right;"><?php echo $totalSubSet1s;?>&nbsp;&nbsp;</td>
              </tr>
              <tr>
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">2</td>
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                <select name="spro2" id="spro2" class="inputselect" style="width: 90%;height: 28px;">
                  <option value="เงินประกันสินค้า" <?php if($spro2 == 'เงินประกันสินค้า'){echo 'selected';}?>>เงินประกันสินค้า</option>
                  <option value="ค่าเช่าล่วงหน้า 2 เดือน" <?php if($spro2 == 'ค่าเช่าล่วงหน้า 2 เดือน'){echo 'selected';}?>>ค่าเช่าล่วงหน้า 2 เดือน</option>
                </select>
                <!-- <input type="text" name="spro2" value="<?php  echo $spro2;?>" id="spro2" class="inpfoder" style="width:90%;height:27px;"> -->
                </td>
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><input type="text" name="sqty2" value="<?php  echo $sqty2;?>" id="cs_amount2" class="inpfoder" style="width:90%;text-align:center;height:27px;"></td>
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><input type="text" name="sprice2" value="<?php  echo $sprice2;?>" id="cs_amount1" class="inpfoder" style="width:90%;text-align:center;height:27px;">
                <td style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><input type="text" name="sdisc2" value="<?php  echo $sdisc2;?>" id="cs_amount1" class="inpfoder" style="width:90%;text-align:center;height:27px;">
                <td style="border:1px solid #000000;padding:5;text-align:right;"><?php echo $totalSubSet2s;?>&nbsp;&nbsp;</td>
              </tr>
              <tr>
                <td colspan="4" style="border:0px solid #003399;padding:9px 5px;"></td>
                <td style="border:1px solid #003399;padding:9px 5px;"><strong>รวมทั้งหมด</strong></td>
                <td style="border:1px solid #003399;padding:9px 5px;text-align:right;"><?php echo number_format($sumpriceSet,2);?>&nbsp;&nbsp;</td>
              </tr>
              <tr>
                <td colspan="4" style="border:0px solid #003399;padding:9px 5px;"></td>
                <td style="border:1px solid #003399;padding:9px 5px;"><strong>VAT 7 %</strong></td>
                <td style="border:1px solid #003399;padding:9px 5px;text-align:right;"><?php echo number_format($sumpricevatSet,2);?>&nbsp;&nbsp;</td>
              </tr>
              <tr>
                <td colspan="4" style="text-align:center;border:0px solid #003399;padding:9px 5px;background-color: #ddebf7;"><strong><?php echo baht_text($sumtotalsSet);?></strong></td>
                <td style="border:1px solid #003399;padding:9px 5px;"><strong>ราคารวมทั้งสิ้น</strong></td>
                <td style="border:1px solid #003399;padding:9px 5px;text-align:right;"><?php echo number_format($sumtotalsSet,2);?>&nbsp;&nbsp;</td>
              </tr>
            </table></td>
          </tr>
        </table>
  ...
  <br>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
      <tr>
        ...
        <p>
        1. ชำระค่าบริการขนส่ง/ติดตั้ง และ<?php echo $spro2;?> ณ วันอนุมัติสั่งซื้อสินค้าหรือตามเงื่อนไขการขาย<br>
			  2. ชำระค่าเช่าวันที่ <input type="text" name="paysad" value="<?php echo $paysad;?>" style="text-align: center;width: 50px;"> ของทุกๆเดือน
        </p>    
        <p><strong>เงื่อนไขการรับประกันและการส่งสินค้า</strong></p>
        <p>
			1. การรับประกันสินค้า รับประกันตัวเครื่อง อะไหล่และบริการหลังการขายตลอดอายุการใช้งาน ฟรี<br>			
		  ...
		  <?php
              $qusTec = @mysql_query("SELECT * FROM  `s_group_service` WHERE  `group_ser_id` !=  '' ORDER BY `group_ser_id` ASC");
              while($rowTec = @mysql_fetch_array($qusTec)){
                ?>
      ...
      5. กำหนดยืนราคา <input type="text" name="giveprice" value="<?php echo $giveprice;?>" style="text-align: center;width: 50px;"> วัน
        </p>   
        </td>
      </tr>
    </table>
