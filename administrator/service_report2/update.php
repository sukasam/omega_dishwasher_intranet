	...
	if ($_POST['mode'] == "add") {
		...
		foreach ($codes as $a => $b) {
			...
			if ($lists[$a] != "") {
				...
				@mysqli_query($conn, "INSERT INTO `s_service_report2sub` (`r_id`, `sr_id`, `codes`, `lists`, `units`, `prices`, `amounts`, `opens`, `remains`) VALUES (NULL, '" . $id . "', '" . $codes[$a] . "', '" . $lists[$a] . "', '" . $units[$a] . "', '0', '" . $amounts[$a] . "', '" . $opens[$a] . "', '" . ($amounts[$a] - $opens[$a]) . "');");
...
if ($_GET['mode'] == "add") {
	...
	//		 
	$rowSR3 = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM s_service_report3 WHERE srid = '" . $_GET['srid'] . "'"));
	$srid2 = $rowSR3['sv_id'];
	//echo "MKUNG=".$srid2;
	...
	<DIV id="body-wrapper">
		...
		<DIV id="main-content">
			...
			<UL class="shortcut-buttons-set">
				<LI><A class="shortcut-button" href="../service_report/?mid=13"><SPAN><IMG alt="icon" src="../images/btn_back.gif"><BR>
							กลับ</SPAN></A></LI>
			</UL>
			<!-- End .clear -->
			...
			<DIV class="content-box">
				...
				<DIV class="content-box-content">
					...
					?>
							<option value="<?php echo $row_cusf['fo_id']; ?>" <?php if ($row_cusf['fo_id'] == $rowSR['cus_id']) {
																					echo 'selected';
							...
							?>
															...
															<span id="rsnameid"><input type="hidden" name="cus_id" value="<?php echo $rowSR['cus_id']; ?>"></span>
														...
														<td><strong>ประเภทบริการลูกค้า :</strong>
															<select name="sr_ctype" id="sr_ctype">
																...
																?>
																	<option value="<?php echo $row_cusftype['group_id']; ?>" <?php if ($row_cusftype['group_id'] == $rowSR['sr_ctype']) {
																																	echo 'selected';
															...
															<select name="sr_ctype2" id="sr_ctype2">
																...
																?>
																		<option value="<?php echo $row_cusftype2['group_id']; ?>" <?php if ($row_cusftype2['group_id'] == $rowSR['sr_ctype2']) {
																																		echo 'selected';
													...
													<tr>
														...
														<td><strong>เลขที่บริการ</strong> :
															...
															<!--<input type="text" name="sv_id" value="<?php if ($sv_id == "") {
																											...
																											echo $rowSR['sv_id'];
																										}; ?>" id="sv_id" class="inpfoder" style="border:0;">&nbsp;&nbsp;เลขที่สัญญา  :</strong> <span id="contactid"><?php echo $finfo['fs_id']; ?></span>-->
													...
													<tr>
														...
														<td><strong>วันที่เบิกอะไหล่ :</strong> <span id="datef"></span>
															<input type="text" name="job_open" readonly value="<?php if ($job_open == "") {
																													echo date("d/m/Y");
																												} else {
																													echo $job_open;
																												} ?>" class="inpfoder" />
													...
													<tr>
														...
														<td>
															<!--<strong>บริการครั้งล่าสุด : </strong> <span id="sevlast"><?php echo get_lastservice_f($conn, $cus_id, $sv_id); ?></span> &nbsp;&nbsp;&nbsp;&nbsp;--><strong>กำหนดคืนอะไหล่ :</strong> <span id="datet"></span>
															<input type="text" name="job_balance" readonly value="<?php if ($job_balance == "") {
																														echo date("d/m/Y");
																													} else {
																														echo $job_balance;
																													} ?>" class="inpfoder" />
															...
															<input type="hidden" name="job_close" value="<?php if ($job_close == "") {
																												echo date("d/m/Y");
																											} else {
																												echo $job_close;
																											} ?>" class="inpfoder" />&nbsp;&nbsp;<strong>วันที่คืนอะไหล่ :</strong><span style="font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
																<input type="text" name="sr_stime" readonly value="<?php if ($sr_stime == "") {
																														echo date("d/m/Y");
																													} else {
																														echo $sr_stime;
																													} ?>" class="inpfoder" />
													...
													<tr>
														...
														<td><strong>อ้างอิงใบยืม </strong>: <strong>
																...
																<input type="text" name="ref_date" readonly value="<?php if ($ref_date == "") {
																														echo date("d/m/Y");
																													} else {
																														echo $ref_date;
																													} ?>" class="inpfoder" />
          ...
          <span id="prolist">
          		<?php
					...
					$plid = "<select name=\"bbfpro\" id=\"bbfpro\" onchange=\"get_podsn(this.value,'lpa1','lpa2','lpa3','" . $rowSR['cus_id'] . "')\">
								<option value=\"\">กรุณาเลือก</option>       
							 ";
          ...
          <br />-->
															...
															<select name="loc_contact" id="loc_contact">
																...
																?>
																	<option value="<?php echo $row_custec['group_id']; ?>" <?php if ($row_custec['group_id'] == $rowSR['loc_contact']) {
																																echo 'selected';
												...
												<center>
													<br>
													<span style="font-size:18px;font-weight:bold;">รายละเอียดการเปลี่ยนอะไหล่</span>
												</center><br>
												<div>
													...
													<tr>
															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td style="border-bottom:1px solid #000000;padding-bottom:10px;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;"><strong>
																			<select name="loc_contact2" id="loc_contact2" style="width:50%;">
																				...
																				while ($row_custec = @mysqli_fetch_array($qu_custec)) {
																				?>
																					<option value="<?php echo $row_custec['group_id']; ?>" <?php if ($row_custec['group_id'] == $loc_contact2) {
																																				echo 'selected';
																																			} ?>><?php echo $row_custec['group_name'] . " (Tel : " . $row_custec['group_tel'] . ")"; ?></option>
																				<?php
																				}
																...
																<tr>
																	<td style="font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;"><strong>วันที่ : </strong>
																		<input type="text" name="loc_date2" readonly value="<?php if ($loc_date2 == "") {
																																echo date("d/m/Y");
																															} else {
																																echo $loc_date2;
																															} ?>" class="inpfoder" />
														...
														<td width="33%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;padding-top:10px;padding-bottom:10px;">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td style="border-bottom:1px solid #000000;padding-bottom:10px;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;"><strong>
																			<select name="cs_sell" id="cs_sell" class="inputselect" style="width:50%;">
																				...
																				while ($row_custec = @mysqli_fetch_array($qu_custec)) {
																				?>
																					<option value="<?php echo $row_custec['group_id']; ?>" <?php if ($row_custec['group_id'] == $cs_sell) {
																																				echo 'selected';
																																			} ?>><?php echo $row_custec['group_name'] . " (Tel : " . $row_custec['group_tel'] . ")"; ?></option>
																				<?php
																				}
																...
																<tr>
																	<td style="font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;"><strong>วันที่ :</strong>
																		<input type="text" name="sell_date" readonly value="<?php if ($sell_date == "") {
																																echo date("d/m/Y");
																															} else {
																																echo $sell_date;
																															} ?>" class="inpfoder" />
														...
														<td width="33%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;padding-top:10px;padding-bottom:10px;">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td style="border-bottom:1px solid #000000;padding-bottom:10px;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;"><strong>
																			<select name="loc_contact3" id="loc_contact3" style="width:50%;">
																				...
																				while ($row_custec = @mysqli_fetch_array($qu_custec)) {
																					if ($loc_contact3 != "") {
																						$loc_contact3 = $loc_contact3;
																					} else {
																						$loc_contact3 = 11;
																					}
																				?>
																					<option value="<?php echo $row_custec['group_id']; ?>" <?php if ($row_custec['group_id'] == $loc_contact3) {
																																				echo 'selected';
																																			} ?>><?php echo $row_custec['group_name'] . " (Tel : " . $row_custec['group_tel'] . ")"; ?></option>
																				<?php
																				}
																...
																<tr>
																	<td style="font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;"><strong>วันที่ :</strong>
																		<input type="text" name="loc_date3" readonly value="<?php if ($loc_date3 == "") {
																																echo date("d/m/Y");
																															} else {
																																echo $loc_date3;
																															} ?>" class="inpfoder" />
