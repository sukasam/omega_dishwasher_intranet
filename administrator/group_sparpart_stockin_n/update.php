	...
	if ($_POST["mode"] == "add") {
		...
		for ($i = 0; $i <= count($_POST['cpro']); $i++) {
			if ($_POST['cpro'][$i] != "") {
				...
				@mysqli_query($conn, "INSERT INTO `s_group_sparpart_bill_pro` (`id`, `id_bill`, `sparpart_id`, `sparpart_qty`, `sparpart_unit_price`, `sparpart_total`) VALUES (NULL,'" . $id . "','" . $_POST['cpro'][$i] . "','" . $_POST['camount'][$i] . "','0','0');");
		...
		<DIV id=main-content>
			...
			<UL class=shortcut-buttons-set>
				<LI><A class=shortcut-button href="index.php"><SPAN><IMG alt=icon src="../images/btn_back.gif"><BR>
							กลับ</SPAN></A></LI>
							<LI><A class=shortcut-button href="../group_sparpart_stockin/update.php?mode=add"><SPAN><IMG  alt=icon src="../images/icons/icon-48-info.png" width="31px"><BR>
								...
								<fieldset>
												...
												<td>
													<table class="formFields" cellspacing="0" width="100%">
														...
														<tr>
															...
															<td><input type="text" name="stock_date" readonly value="<?php if ($stock_date == "") {
																															echo date("d/m/Y");
																														} else {
																															echo $stock_date;
																														} ?>" class="inpfoder" />
												...
												<td>
													<table class="formFields" cellspacing="0" width="100%">
														<tr>
															...
															<td><input name="sub_billnum" type="text" id="sub_billnum" value="<?php echo $sub_billnum; ?>" size="20%">&nbsp;&nbsp;วันที่บิล <input type="text" name="sub_billdate" readonly value="<?php if ($sub_billdate == "") {
																																																														echo date("d/m/Y");
																																																													} else {
																																																														echo $sub_billdate;
																																																													} ?>" class="inpfoder" />
														...
														<tr>
															<td nowrap class="name" colspan="2">
																<input name="sub_vat" type="radio" id="radio" value="1" <?php if ($sub_vat == 1) {
																															echo 'checked';
																														} ?>>Not vat &nbsp;
																<input name="sub_vat" type="radio" id="radio" value="2" <?php if ($sub_vat == 2 || $sub_vat == "") {
																															echo 'checked';
																														} ?>>Vat 7%
															</td>
														</tr>
														<tr>
															<td colspan="2"><strong>แสกนรหัสอะไหล่ : </strong><input name="scan_part" type="text" id="scan_part" value="" size="30"> <span id="msg_scan" style="color:red;font-weight: bold;"></span></td>
														</tr>
													</table>
												</td>
											</tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;text-align:center;">
										<tr>
											...
											<td width="5%" style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;"><strong>รหัสบาร์โค้ด</strong></td>
