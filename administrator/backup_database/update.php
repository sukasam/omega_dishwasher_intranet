<?php 
	...
	$bfil = backup_tables($conn,'localhost','root','','omega_intranet');
	
	$_POST['group_name'] = "Database ".date("Ymdhis");
	$_POST['group_file'] = $bfil;
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td><table class="formFields" cellspacing="0" width="100%">
              <tr >
                <td nowrap class="name">รหัสประเภทบริการ</td>
                <td><input name="group_ser_id" type="text" id="group_ser_id"  value="<?php  echo $group_ser_id; ?>" size="60"></td>
              </tr>
              <tr >
                <td nowrap class="name">ชื่อประเภทบริการ</td>
