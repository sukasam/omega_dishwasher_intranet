<?php
    ...
    $_POST["paym2"] = eregi_replace(",","",$_POST["paym2"]);
    $_POST["paym3"] = eregi_replace(",","",$_POST["paym3"]);
...
<table width="100%" cellspacing="0" cellpadding="0" class="tb1">
          ...
          <tr>
            ...
            <input type="text" name="fs_id" value="<?php  if($fs_id == ""){echo check_quotation("QA-B ".date("Y/m/"));}else{echo $fs_id;};?>" id="fs_id" class="inpfoder" > 
            </td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <p>
        	<input type="radio" name="payc" value="1" <?php if($payc == "1"){echo "checked";}?>> ชำระเงินสด
       		<br>
       		<span style="padding-left: 23px;">ชำระมัดจำสินค้า จำนวน</span> <?php echo number_format($paym,2);?> บาท ณ วันอนุมัติสั่งซื้อสินค้า <br/>
