...
<title>เลือกตามการใช้อะไหล่ ( <?php  if($cpro != ""){echo get_sparpart_name($cpro);}else{echo "ทั้งหมด";}?> )</title>
<style type="text/css">
 .tbreport{
 	font-size:10px;
 }
...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
	  <tr>
        ...
        รายงานตามการใช้อะไหล่ ( <?php  if($cpro != ""){echo get_sparpart_name($cpro);}else{echo "ทั้งหมด";}?> )<br />
        ประเภทลูกค้า  :
      ...
      <?php  
		...
		while($row_fr = @mysql_fetch_array($qu_fr)){
			...
			<tr>
              ...
              <?php  if($_REQUEST['sh10'] == 1){?><td><?php  echo get_technician_id($row_fr['loc_contact']);?></td><?php  }?>
      </tr>
