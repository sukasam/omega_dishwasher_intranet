      ...
      <?php  
		...
		while($row_fr = @mysql_fetch_array($qu_fr)){
			...
			<tr>
              ...
              <?php  if($_REQUEST['sh1'] == 1){?><td><?php  echo $row_fr['loc_name']."<br />".$row_fr['loc_address'];?></td><?php  }?>
              <?php  if($_REQUEST['sh1'] == 1){?><td><?php  echo getcustom_type($row_fr['sr_ctype2']);?></td><?php  }?>
              <?php  if($_REQUEST['sh1'] == 1){?><td><?php  echo get_servicename($row_fr['sr_ctype']);?></td><?php  }?>
