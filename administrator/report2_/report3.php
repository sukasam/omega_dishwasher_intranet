...
<?php  if($_POST['sr_ctype']){echo get_servicename($conn,$_POST['sr_ctype']);}else{echo "ทั้งหมด";}?></th>
      ...
      <tr>
        ...
        <th width="12%">เลขที่ใบบริการ</th>
        <th width="16%">วันที่ เปิด / ปิดใบบริการ</th>
      ...
      <?php  
		...
		while($row_fr = @mysqli_fetch_array($qu_fr)){
			...
			<tr>
              ...
              <td><?php  echo format_date($conn,$row_fr['job_open'])." / ". ($row_fr['job_close']);?></td>
              <td><?php  echo format_date($conn,$row_fr['sr_stime']);?></td>   
