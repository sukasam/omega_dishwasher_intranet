<?php 
	...
	if($_GET['action'] == "delete"){
		...
		if ($code == "1") {
			...
			header ("location:index3.php?catv1=".$_GET['catv1']."&catv2=".$_GET['catv2']);
		} 
	}
?>
...
<?php  include('../top.php');?>
<P id=page-intro><?php  echo $page_name." (".getCatSparev2($conn,$_GET['catv2']).")"; ?></P>

<UL class=shortcut-buttons-set>
  <LI><A class=shortcut-button href="update3.php?mode=add<?php  if ($param <> "") echo "&".$param; ?>&catv1=<?php echo $_GET['catv1'];?>&catv2=<?php echo $_GET['catv2'];?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
    เพิ่ม</SPAN></A></LI>
    
  <LI><A class=shortcut-button href="../group_cat_spare/index2.php?catv1=<?php echo $_GET['catv1'];?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif" width="45"><BR>
  กลับ</SPAN></A></LI>
...
<H3 align="left"><?php  echo $page_name." (".getCatSparev2($conn,$_GET['catv2']).")"; ?></H3>
<br><form name="form1" method="get" action="index3.php">
    ...
    <?php 
			...
			$param2 = get_param($a_param,$a_not_exists);
			  ?>
    <a href="index3.php?<?php  echo $param2;?>&catv1=<?php  echo $_GET['catv1'];?>&catv2=<?php  echo $_GET['catv2'];?>">แสดงทั้งหมด</a>
    <?php  
			/*$a_not_exists = array();
	...
	?>
      ...
      <TBODY>
        <?php  
					...
					if ($_REQUEST['catv2'] <> "") { 
						$sql .= " and group_cat2_id = '".$_REQUEST['catv2']."'";
					}
        ...
        <TR>
		  ...
		  <TD><!-- Icons -->
            <A title="Add Sub" href="index4.php?catv1=<?php  echo $_GET['catv1'];?>&catv2=<?php  echo $_GET['catv2'];?>&catv3=<?php  echo $rec[$PK_field];?>"><center><IMG alt=Edit src="../images/icon2/module.png" width="25"></center></A></TD>
          <TD><!-- Icons -->
            <A title=Edit href="update3.php?mode=update&catv1=<?php echo $_GET['catv1'];?>&catv2=<?php echo $_GET['catv2'];?>&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field]; if($param <> "") {?>&<?php  echo $param; }?>"><IMG alt=Edit src="../images/pencil.png"></A></TD>
          <TD><A title=Delete  href="#"><IMG alt=Delete src="../images/cross.png" onClick="confirmDelete('?action=delete&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field];?>&catv1=<?php echo $_GET['catv1'];?>&catv2=<?php echo $_GET['catv2'];?>','Group  <?php  echo $rec[$PK_field];?> : <?php  echo $rec["group_name"];?>')"></A></TD>
        </TR>  
		<?php  }?>
      </TBODY>
    </TABLE>
