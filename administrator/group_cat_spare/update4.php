<?php 
	...
	if ($_POST['mode'] <> "") { 
		...
		$_POST['group_cat_id'] = $_POST['catv1'];
		$_POST['group_cat2_id'] = $_POST['catv2'];
		$_POST['group_cat3_id'] = $_POST['catv3'];

		if ($_POST['mode'] == "add") { 
				include "../include/m_add.php";
			header ("location:index4.php?" . $param."&catv1=".$_POST['catv1']."&catv2=".$_POST['catv2']."&catv3=".$_POST['catv3']); 
		}
...
<DIV id=tab1 class="tab-content default-tab">
  <form action="update4.php" method="post" enctype="multipart/form-data" name="form1" id="form1"  onSubmit="return check(this)">
    <div class="formArea">
      <fieldset>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td><table class="formFields" cellspacing="0" width="100%">
              <!-- <tr >
                <td nowrap class="name">รหัส</td>
                <td><input name="group_fix_id" type="text" id="group_fix_id"  value="<?php  echo $group_fix_id; ?>" size="60"></td>
              </tr> -->
              <tr >
                <td nowrap class="name">ชื่อหมวดหมู่</td>
