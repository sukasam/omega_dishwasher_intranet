...
<?php  include('../top.php');?>
<P id=page-intro><?php  echo $page_name." (".getCatSparev1($conn,$_GET['catv1']).")"; ?></P>
...
<UL class=shortcut-buttons-set>
  ...
  <LI><A class=shortcut-button href="../group_cat_spare/index.php"><SPAN><IMG  alt=icon src="../images/btn_back.gif" width="45"><BR>
  กลับ</SPAN></A></LI>
...
<H3 align="left"><?php  echo $page_name." (".getCatSparev1($conn,$_GET['catv1']).")"; ?></H3>
