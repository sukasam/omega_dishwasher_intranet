          ...
          <tr>
            <td><table class="formFields" cellspacing="0" width="100%">
             <tr >
              ...
              <tr >
                <td nowrap class="name">ตำแหน่ง</td>
                <td><?php  echo $group_position; ?><input name="group_position" type="hidden" id="group_position"  value="<?php  echo $group_position; ?>" size="60"></td>
              </tr>
          </table></td>
          </tr>
        </table>
