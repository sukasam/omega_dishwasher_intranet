...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:10px;text-align:center;">
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;text-align:left;padding:5;">'.get_sparpart_name($_POST["cpro1"]).'</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;text-align:left;padding:5;">'.get_sparpart_name($_POST["cpro2"]).'</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;text-align:left;padding:5;">'.get_sparpart_name($_POST["cpro3"]).'</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;text-align:left;padding:5;">'.get_sparpart_name($_POST["cpro4"]).'</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;text-align:left;padding:5;">'.get_sparpart_name($_POST["cpro5"]).'</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;text-align:left;padding:5;">'.get_sparpart_name($_POST["cpro6"]).'</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #000000;text-align:left;padding:5;">'.get_sparpart_name($_POST["cpro7"]).'</td>
