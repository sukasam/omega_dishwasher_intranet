	...
	?>
      ...
      <TBODY>
        ...
        <TR>
		  ...
		  <TD><!-- Icons -->
            <A title="Add Sub" href="index2.php?catv1=<?php  echo $rec[$PK_field];?>"><center><IMG alt=Edit src="../images/icon2/module.png" width="25"></center></A></TD>
          <TD><!-- Icons -->
            <A title=Edit href="update.php?mode=update&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field]; if($param <> "") {?>&<?php  echo $param; }?>"><IMG alt=Edit src="../images/pencil.png"></A></TD>
