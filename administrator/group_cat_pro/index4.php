...
<?php  include('../top.php');?>
<P id=page-intro><?php  echo $page_name." (".getCatProv3($conn,$_GET['catv3']).")"; ?></P>
...
<UL class=shortcut-buttons-set>
  ...
  <LI><A class=shortcut-button href="../group_cat_pro/index3.php?catv1=<?php echo $_GET['catv1'];?>&catv2=<?php echo $_GET['catv2'];?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif" width="45"><BR>
  กลับ</SPAN></A></LI>
...
<H3 align="left"><?php  echo $page_name." (".getCatProv3($conn,$_GET['catv3']).")"; ?></H3>
