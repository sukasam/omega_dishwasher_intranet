...
<?php    
	...
	$fieldlist = array('group_spar_id','group_spar_account_id','group_name','group_namecall','group_unit_price','group_price','group_spar_barcode','catv1','catv2','catv3','catv4','u_images');
