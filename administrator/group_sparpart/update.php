          ...
          <tr>
            <td><table class="formFields" cellspacing="0" width="100%">
              <tr >
                ...
                <td><input name="group_spar_id" type="text" id="group_spar_id"  value="<?php  echo $group_spar_id; ?>" size="60"></td>
              </tr>
              <tr >
                <td nowrap class="name">New Code</td>
                <td><input name="group_spar_code" type="text" id="group_spar_code"  value="<?php  echo $group_spar_code; ?>" size="60"></td>
              </tr>
              <tr >
